...
Пускай лежит здесь. Отдыхает.

## Сервер конфигурации
Сервере конфигурации это некая прослойка для конфигурации, которая работает с моделью, при этом она поддерживает коммандный интерфейс

![](images/img_conf_server_scheme.png)
...
### Поддерживаемые команды:
 ...
 3) Удалить объект
 4) Получить дерево объектов
 5) Распахнуть дерево объектов 
 6) Свернуть дерево объектов

...
namespace WebAssembly.Browser.DOM
{
    ...
    {
        static readonly JSObject domBrowserInterface =
            (JSObject) ((JSObject) Runtime.GetGlobalObject("WebAssembly_Browser_DOM")).GetObjectProperty("prototype");
        ...
        protected void SetProperty<T>(string expr, T value, bool createIfNotExists = true, bool hasOwnProperty = false)
        {
            ...
            else
            {
                ...
                {
                    ManagedJSObject.SetObjectProperty(expr, ((DOMObject) (object) value).ManagedJSObject,
                        createIfNotExists, hasOwnProperty);
                }
                else
                    ManagedJSObject.SetObjectProperty(expr, value, createIfNotExists, hasOwnProperty);
            }
...
//#endif
                var jsobjectconstructor = type.GetConstructor(
...
#endif
            domBrowserInterface.Invoke("mono_wasm_add_js_event_listener", ManagedJSObject, eventName, eventDelegate,
                uid);
        }

...
namespace ZenPlatform.EntityComponent.Configuration
{
    ...
    public class SingleEntity : XCObjectTypeBase
    {
        public SingleEntity()
        {
            Properties = new ChildItemCollection<SingleEntity, SingleEntityProperty>(this);
        ...
        /// </summary>
        [XmlArray]
        [XmlArrayItem(ElementName = "Property", Type = typeof(SingleEntityProperty))]
        public ChildItemCollection<SingleEntity, SingleEntityProperty> Properties { get; }

...
namespace ZenPlatform.EntityComponent.Entity
{
    public class NewPlatformGenerator : IPlatformGenerator
    {
        ...
        private void GenerateClientDtoClass(XCObjectTypeBase type, Root root)
        {
            ...
            var cls = new ComponentClass(_component, set, null, dtoClassName, new TypeBody(members));
        ...
        private void GenerateObjectClass(XCObjectTypeBase type, Root root)
        {
            ...
            var cls = new ComponentClass(_component, singleEntityType, null, className, new TypeBody(members));
            cls.Namespace = @namespace;
        ...
        private void GenerateCommands(XCObjectTypeBase type, Root root)
        {
            ...
            foreach (var command in type.GetCommands())
            {
                ...
                var moduleCls = new ComponentModule(_component, set, null, $"__cmd_{command.Name}", typeBody);

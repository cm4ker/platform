...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QAliasedDataSource : QDataSource
    {
        ...
        public QDataSource Parent { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return (Compare(this.Parent, node.Parent) && Compare(this.Alias, node.Alias));
        }
...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QAliasedSelectExpression : QSelectExpression
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return (Compare(this.Expression, node.Expression) && Compare(this.Alias, node.Alias));
        }
...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QCase : QExpression
    {
        ...
        public List<QCaseWhen> Whens { get; set; }
        ...
        public override bool Equals(object obj)
        {
            if (!this.GetType().Equals(obj.GetType()))
                return false;
            var node = (QCase) obj;
            return (SequenceEqual(this.Whens, node.Whens));
        }
...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QCaseWhen : QItem
    {
        ...
        public override bool Equals(object obj)
        {
            if (!this.GetType().Equals(obj.GetType()))
                return false;
            var node = (QCaseWhen) obj;
            return (Compare(this.Else, node.Else) && Compare(this.Then, node.Then) && Compare(this.When, node.When));
        }

        public override int GetHashCode()
        {
            return (Else == null ? 0 : Else.GetHashCode()) ^ (Then == null ? 0 : Then.GetHashCode()) ^
                   (When == null ? 0 : When.GetHashCode());
        }
...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QLessThenOrEquals : QOperationExpression
    {
        ...
        public override bool Equals(object obj)
        {
            if (!this.GetType().Equals(obj.GetType()))
                return false;
            var node = (QLessThenOrEquals) obj;
            return (Compare(this.Left, node.Left) && Compare(this.Right, node.Right));
        }
...
namespace ZenPlatform.Core.Querying.Model
{
    public partial class QGreatThenOrEquals : QOperationExpression
    {
        ...
        public override bool Equals(object obj)
        {
            if (!this.GetType().Equals(obj.GetType()))
                return false;
            var node = (QGreatThenOrEquals) obj;
            return (Compare(this.Left, node.Left) && Compare(this.Right, node.Right));
        }

...
namespace Aquila.Runtime.Tests
{
    ...
    {
        private MsSqlBuilder _visitor;

        public BuildersTest()
        {
            _visitor = new MsSqlBuilder();
        }
        ...
        public void AddForeignKeyConstraintWithName()
        {
            ...
            var actual = _visitor.Visit(addConstraint);

            var expected =
                "ALTER TABLE MyTable\n ADD CONSTRAINT fk_column1_column2 FOREIGN KEY (Column1,Column2) REFERENCES ForeignTable(Column1,Column2)";

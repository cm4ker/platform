...
namespace OmniSharp.LanguageServerProtocol
{
    public static class Helpers
    {
        ...
        public static WorkspaceEdit ToWorkspaceEdit(IEnumerable<FileOperationResponse> responses,
            WorkspaceEditCapability workspaceEditCapability, DocumentVersions documentVersions)
        {
        ...
        public static WorkspaceEditDocumentChange ToWorkspaceEditDocumentChange(FileOperationResponse response,
            WorkspaceEditCapability workspaceEditCapability, DocumentVersions documentVersions)
        {
            workspaceEditCapability ??= new WorkspaceEditCapability();
            workspaceEditCapability.ResourceOperations ??= Array.Empty<ResourceOperationKind>();
            ...
            if (response is RenamedFileResponse rename &&
    ...
    public static class CommandExtensions
    {
        ...
        public static (T arg1, T2 arg2) ExtractArguments<T, T2>(this IExecuteCommandParams command,
        ...
        public static (T arg1, T2 arg2, T3 arg3) ExtractArguments<T, T2, T3>(this IExecuteCommandParams command,
            ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull =>
        ...
        public static (T arg1, T2 arg2, T3 arg3) ExtractArguments<T, T2, T3>(this Command command,
            ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull =>
        ...
        public static (T arg1, T2 arg2, T3 arg3, T4 arg4) ExtractArguments<T, T2, T3, T4>(this Command command,
            ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull
        ...
        public static (T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) ExtractArguments<T, T2, T3, T4, T5>(
            this IExecuteCommandParams command, ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull
        ...
        public static (T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) ExtractArguments<T, T2, T3, T4, T5, T6>(
            this IExecuteCommandParams command, ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull
        ...
        private static (T arg1, T2 arg2, T3 arg3, T4 arg4) ExtractArguments<T, T2, T3, T4>(JArray args,
            ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull
        ...
        private static (T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) ExtractArguments<T, T2, T3, T4, T5>(JArray args,
            ISerializer serializer)
            where T : notnull
            where T2 : notnull
            where T3 : notnull
        ...
        private static (T arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) ExtractArguments<T, T2, T3, T4, T5, T6>(

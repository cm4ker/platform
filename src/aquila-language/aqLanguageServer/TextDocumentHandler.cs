...
namespace Aquila.LanguageServer
{
    internal class TextDocumentHandler : TextDocumentSyncHandlerBase
    {
        ...
        public override Task<Unit> Handle(DidChangeTextDocumentParams notification, CancellationToken token)
        {
            ...
            _logger.LogInformation("Hello from change document");
            return Unit.Task;
        }
    ...
    internal class MyDocumentSymbolHandler : IDocumentSymbolHandler
    {
        ...
        )
        {
            ...
            var content = await File.ReadAllTextAsync(DocumentUri.GetFileSystemPath(request) ?? string.Empty, cancellationToken)

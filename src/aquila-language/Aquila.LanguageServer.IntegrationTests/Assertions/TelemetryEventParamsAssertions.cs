...
namespace Aquila.LanguageServer.IntegrationTests.Assertions
{
    ...
    public class
        TelemetryEventParamsAssertions : ReferenceTypeAssertions<TelemetryEventParams, TelemetryEventParamsAssertions>
    {
        ...
        public AndConstraint<TelemetryEventParamsAssertions> HaveEventNameAndProperties(string eventName,
            JObject properties, string because = "", params object[] becauseArgs)
        {

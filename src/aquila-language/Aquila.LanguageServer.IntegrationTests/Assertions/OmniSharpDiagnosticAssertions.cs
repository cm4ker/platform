...
namespace Aquila.LanguageServer.IntegrationTests.Assertions
{
    ...
    public class OmniSharpDiagnosticAssertions : ReferenceTypeAssertions<Diagnostic, OmniSharpDiagnosticAssertions>
    {
        ...
        public AndConstraint<OmniSharpDiagnosticAssertions> HaveCodeAndSeverity(string code,
            DiagnosticSeverity severity, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion

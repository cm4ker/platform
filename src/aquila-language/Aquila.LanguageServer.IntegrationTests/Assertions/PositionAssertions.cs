...
namespace Aquila.LanguageServer.IntegrationTests.Assertions
{
    ...
    public class PositionAssertions : ReferenceTypeAssertions<Position, PositionAssertions>
    {
        ...
        public AndConstraint<PositionAssertions> HavePosition(int line, int character, string because = "",
            params object[] becauseArgs)
        {
            Execute.Assertion
                ...
                .FailWith("Expected position line {0} char {1}, but found line {2}, char {3}", _ => line,
                    _ => character, p => p.Line, p => p.Character);

...
//             var bicepSourceFileName = Path.Combine("src", "Aquila.LanguageServer.IntegrationTests", pathPrefix, Path.GetRelativePath(outputDirectory, bicepFileName));
...
//                 var combinedSourceFileName = Path.Combine("src", "Aquila.LanguageServer.IntegrationTests", pathPrefix, Path.GetRelativePath(outputDirectory, combinedFileName));

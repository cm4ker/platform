...
namespace Aquila.LanguageServer.IntegrationTests.Helpers
{
    public static class TextDocumentParamHelper
    {
        public static DidOpenTextDocumentParams CreateDidOpenDocumentParams(DocumentUri documentUri, string text,
            int version) =>
        ...
        public static DidChangeTextDocumentParams CreateDidChangeTextDocumentParams(DocumentUri documentUri,
        ...
        public static DidSaveTextDocumentParams CreateDidSaveTextDocumentParams(DocumentUri documentUri, string text,
            int version)
        {

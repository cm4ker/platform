...
namespace Aquila.Migrations
{
    public class MigrationManager
    {
        ...
        private void RunMigration(EntityMetadataCollection old, EntityMetadataCollection actual, Guid id,
            DataConnectionContext context)
        {
            var migrator = new EntityMigratorContext();
            var plan = new EntityMigrationPlan();

            //load instance of DatabaseRuntimeContext
            var runtimeContext = new DatabaseRuntimeContext();
            runtimeContext.Load(context);

            var migrationContext = new EntityMigratorDataContext(runtimeContext, old, actual, context);

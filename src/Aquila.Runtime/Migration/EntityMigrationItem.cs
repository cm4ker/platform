...
namespace Aquila.Migrations
{
    ...
    {
        void Visit(EntityMigrationPlanBuilder visitor, DDLQuery query);
    }
    ...
    public class AddColumnItem : IEntityMigrationItem
    {
        ...
        public void Visit(EntityMigrationPlanBuilder visitor, DDLQuery query)
        {
    ...
    {
        public SMProperty Property { get; }
        public string TableName { get; }

        public SMType Type { get; }

        public UpdateTypeItem(SMProperty property, string tableName, SMType type)
        {
            Property = property;
            TableName = tableName;
            Type = type;

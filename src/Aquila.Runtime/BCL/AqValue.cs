...
//     /// </summary>
//     /// <remarks>
//     /// Note, <c>default(PhpValue)</c> represents a <c>NULL</c> value, equivalent to <see cref="AqValue.Null"/>.
//     /// </remarks>
//     [StructLayout(LayoutKind.Sequential)]
//     public readonly partial struct AqValue : IPhpConvertible, IEquatable<AqValue> // <T>
//     {
...
//         struct ValueField
//         {
//             [FieldOffset(0)] public bool
//                 @bool; // NOTE: must be first field, having bool as the last field confuses .NET debugger and converts the entire struct to `0` or `1` // https://github.com/peachpiecompiler/peachpie/issues/249 // if still causes issues, remove this field and use Long only
//
...
//             get
//             {
//                 Debug.Assert(TypeCode == PhpTypeCode.Boolean);
//                 return _value.@bool;
//             }
//         }
//
...
//             get
//             {
//                 Debug.Assert(_obj.@object is string || _obj.@object == null);
//                 return _obj.@string;
//             }
//         }
//
...
//         /// </summary>
//         public PhpString MutableString
//         {
//             get { return new PhpString(MutableStringBlob); }
//         }
//
//         /// <summary>
...
//             get
//             {
//                 Debug.Assert(_obj.@object is PhpArray);
//                 return _obj.array;
//             }
//         }
//
...
//             get
//             {
//                 Debug.Assert(_obj.@object is PhpAlias);
//                 return _obj.alias;
//             }
//         }
//
...
//         #region Conversions
//
//         public static implicit operator AqValue(bool value) => Create(value);
//         public static implicit operator AqValue(int value) => Create(value);
//         public static implicit operator AqValue(uint value) => Create((long)value);
//         public static implicit operator AqValue(long value) => Create(value);
//         public static implicit operator AqValue(ulong value) => Create(value);
//         public static implicit operator AqValue(double value) => Create(value);
//         public static explicit operator AqValue(decimal value) => Create((double)value); // loosing precision
//         public static implicit operator AqValue(PhpNumber value) => Create(value);
//         public static implicit operator AqValue(IntStringKey value) => Create(value);
//         public static implicit operator AqValue(string value) => Create(value);
//         public static implicit operator AqValue(byte[] value) => Create(value);
//         public static implicit operator AqValue(PhpArray value) => Create(value);
//         public static implicit operator AqValue(Delegate value) => FromClass(value);
//
//         public static explicit operator bool(AqValue value) => value.ToBoolean();
//
//         public static explicit operator long(AqValue value) => value.ToLong();
//
//         public static explicit operator ushort(AqValue value) => checked((ushort)(long)value);
//
//         public static explicit operator short(AqValue value) => checked((short)(long)value);
//
//         public static explicit operator int(AqValue value) => checked((int)(long)value);
//
//         public static explicit operator uint(AqValue value) => checked((uint)(long)value);
//
//         public static explicit operator double(AqValue value) => value.ToDouble();
//
//         public static explicit operator PhpNumber(AqValue value)
//         {
...
//         }
//
//         public static explicit operator PhpArray(AqValue value) => value.ToArray();
//
//         public static explicit operator DateTime(AqValue value) => value.ToDateTime();
//
//         /// <summary>
...
//         #region Operators
//
//         public static bool operator ==(AqValue left, AqValue right) => left.Compare(right) == 0;
//
//         public static bool operator !=(AqValue left, AqValue right) => left.Compare(right) != 0;
//
//         public static bool operator <(AqValue left, AqValue right) => left.Compare(right) < 0;
...
//         public static bool operator >(AqValue left, AqValue right) => left.Compare(right) > 0;
//
//         public static bool operator ==(string left, AqValue right) => Comparison.Ceq(left, right);
//
//         public static bool operator !=(string left, AqValue right) => !(left == right);
//
//         public static bool operator ==(AqValue left, string right) => right == left;
//
//         public static bool operator !=(AqValue left, string right) => right != left;
//
//         public static AqValue operator ~(AqValue x) => Operators.BitNot(in x);
//
//         public static AqValue operator &(AqValue left, AqValue right) => Operators.BitAnd(in left, in right);
//
//         public static AqValue operator |(AqValue left, AqValue right) => Operators.BitOr(in left, in right);
//
//         public static AqValue operator ^(AqValue left, AqValue right) => Operators.BitXor(in left, in right);
//
//         /// <summary>
...
//         public static PhpNumber operator /(AqValue left, AqValue right) => Operators.Div(in left, in right);
//
//         public static PhpNumber operator *(AqValue left, AqValue right) => PhpNumber.Multiply(left, right);
//
//         public static PhpNumber operator /(long lx, AqValue y)
//         {
...
//         }
//
//         public static double operator /(double dx, AqValue y)
//         {
//             if ((y.ToNumber(out var ny) & Convert.NumberInfo.IsPhpArray) != 0)
//             {
//                 //PhpException.UnsupportedOperandTypes();
...
//         /// </summary>
//         public AqValue this[IntStringKey key]
//         {
//             get { return GetArrayItem(Create(key), false); }
//         }
//
//         public override bool Equals(object obj) => Equals((obj is AqValue) ? (AqValue)obj : FromClr(obj));
//
...
//
//                 case PhpTypeCode.MutableString:
//                     key = Convert.StringToArrayKey(MutableStringBlob
//                         .ToString()); // TODO: corrupts non-Unicode strings https://github.com/peachpiecompiler/peachpie/issues/802
//                     return true;
//
//                 case PhpTypeCode.PhpArray:
//                 case PhpTypeCode.Object:
...
//         public int Compare(AqValue right) => Comparison.Compare(this, right);
//
//         /// <summary>
...
//         public bool StrictEquals(AqValue right) => TypeCode switch
//         {
...
//         /// </summary>
//         public IPhpCallable AsCallable(RuntimeTypeHandle callerCtx = default, object callerObj = null) =>
//             TypeCode switch
//             {
...
//         public static object EnsureObject(ref AqValue value)
//         {
//             object result;
//
...
//         public static IPhpArray EnsureArray(ref AqValue value)
//         {
//             PhpArray tmp;
//
//             switch (value.TypeCode)
...
//                     {
//                         value = new AqValue(value.MutableStringBlob.ReleaseOne());
//                     }
//
//                     //
...
//         public static PhpAlias EnsureAlias(ref AqValue value)
//         {
//             switch (value.TypeCode)
//             {
//                 case PhpTypeCode.PhpArray:
...
//         public readonly AqValue GetValue() => Object is PhpAlias alias ? alias.Value : this;
//
//         /// <summary>
//         /// Accesses the value as an array and gets item at given index.
//         /// Gets <c>NULL</c> value in case the key is not found.
//         /// </summary>
//         public AqValue GetArrayItem(AqValue index, bool quiet = false) => Operators.GetItemValue(this, index, quiet);
//
//         /// <summary>
...
//         /// </summary>
//         public readonly AqValue DeepCopy()
//         {
//             if (((1 << (int)_type) & ((1 << (int)PhpTypeCode.PhpArray) | (1 << (int)PhpTypeCode.MutableString) |
//                                       (1 << (int)PhpTypeCode.Alias))) != 0)
//             {
//                 return DeepCopyImpl();
//             }
//             else
...
//                 case PhpTypeCode.MutableString:
//                     return new AqValue(MutableStringBlob.AddRef());
//                 case PhpTypeCode.Alias:
...
//                     break;
//                 case PhpTypeCode.PhpArray:
//                     ctx.Echo((string)Array);
//                     break;
//                 case PhpTypeCode.String:
//                     ctx.Echo(String);
//                     break;
//                 case PhpTypeCode.MutableString:
//                     MutableStringBlob.Output(ctx);
//                     break;
//                 case PhpTypeCode.Object:
//                     ctx.Echo(Convert.ToString(Object));
//                     break;
//                 case PhpTypeCode.Alias:
//                     Alias.Value.Output(ctx);
//                     break;
//             }
//         }
//
...
//         {
//             if (type == typeof(AqValue)) return GetValue();
//
...
//                     break;
//                 case PhpTypeCode.Boolean:
//                     visitor.Accept(Boolean);
//                     break;
//                 case PhpTypeCode.Long:
//                     visitor.Accept(Long);
//                     break;
//                 case PhpTypeCode.Double:
//                     visitor.Accept(Double);
//                     break;
//                 case PhpTypeCode.PhpArray:
//                     visitor.Accept(Array);
//                     break;
//                 case PhpTypeCode.String:
//                     visitor.Accept(String);
//                     break;
//                 case PhpTypeCode.MutableString:
//                     visitor.Accept(MutableString);
//                     break;
//                 case PhpTypeCode.Object:
//                     visitor.AcceptObject(Object);
//                     break;
//                 case PhpTypeCode.Alias:
//                     visitor.Accept(Alias);
//                     break;
...
//
//         /// <summary>
//         /// Implements <c>foreach</c> over <see cref="AqValue"/>.
//         /// Gets the enumerator object allowing to iterate through PHP values, arrays and iterators.
//         /// </summary>
//         public IEnumerator<KeyValuePair<AqValue, AqValue>> GetEnumerator() =>
//             this.GetForeachEnumerator(false, default(RuntimeTypeHandle));
//
//         #endregion
//
//         #region Helpers
...
//
//         public bool Equals(AqValue other) => this.Compare(other) == 0;
//
//         #endregion
//
//         #region Construction
...
//         public static readonly AqValue Void = default;
//
//         /// <summary>
//         /// Singleton of PhpValue representing <c>null</c>.
//         /// </summary>
//         public static readonly AqValue Null = default;
//
//         /// <summary>
//         /// PhpValue representing <c>false</c>.
//         /// </summary>
//         public static readonly AqValue False = new AqValue(false);
//
//         /// <summary>
//         /// PhpValue representing <c>true</c>.
//         /// </summary>
//         public static readonly AqValue True = new AqValue(true);
//
//         private AqValue(long value) : this(PhpTypeCode.Long)
//         {
//             _value.@long = value;
//         }
//
//         private AqValue(double value) : this(PhpTypeCode.Double)
//         {
//             _value.@double = value;
//         }
//
//         private AqValue(bool value) : this(PhpTypeCode.Boolean)
//         {
//             _value.@bool = value;
//         }
//
//         private AqValue(PhpTypeCode type, object obj) : this(ReferenceEquals(obj, null) ? PhpTypeCode.Null : type)
//         {
//             _obj.@object = obj;
//         }
//
//         internal AqValue(PhpString.Blob blob) : this(PhpTypeCode.MutableString)
//         {
//             Debug.Assert(blob != null);
//             _obj.blob = blob;
//         }
//
//         internal AqValue(string value) : this(PhpTypeCode.String)
//         {
//             Debug.Assert(value != null);
//             _obj.@string = value;
//         }
//
//         internal AqValue(PhpArray array) : this(PhpTypeCode.PhpArray)
//         {
//             Debug.Assert(array != null);
//             _obj.array = array;
//         }
//
//         private AqValue(PhpTypeCode type)
//         {
//             _type = type;
//             _value = default;
//             _obj = default;
//         }
//
//         public static AqValue Create(PhpNumber number) => number.ToPhpValue();
//
//         public static AqValue Create(long value) => new AqValue(value);
//
//         public static AqValue Create(double value) => new AqValue(value);
//
//         public static AqValue Create(int value) => new AqValue(value);
//
//         public static AqValue Create(bool value) => value ? True : False;
//
//         public static AqValue Create(string value) => new AqValue(PhpTypeCode.String, value);
//
//         public static AqValue Create(PhpString value) => PhpString.AsPhpValue(value);
//
//         internal static AqValue Create(PhpString.Blob blob) => new AqValue(blob);
//
//         internal static AqValue Create(byte[] bytes) => new AqValue(new PhpString.Blob(bytes));
//
//         public static AqValue Create(PhpArray value) => new AqValue(PhpTypeCode.PhpArray, value);
//
//         public static AqValue Create(IPhpArray value) =>
//             value is PhpArray arr ? Create(arr) :
//             value is PhpString.Blob blob ? Create(blob) :
//             FromClass(value);
//
//         public static AqValue Create(PhpAlias value) => new AqValue(PhpTypeCode.Alias, value);
//
//         /// <summary>
//         /// Creates <see cref="AqValue"/> from <see cref="Nullable{T}"/>.
//         /// In case <see cref="Nullable{T}.HasValue"/> is <c>false</c>, a <see cref="AqValue.Null"/> is returned.
//         /// </summary>
//         /// <typeparam name="T">Nullable type argument.</typeparam>
//         /// <param name="value">Original value to convert from.</param>
//         /// <returns><see cref="AqValue"/> containing value of given nullable, or <c>NULL</c> if nullable has no value.</returns>
//         public static AqValue Create<T>(T? value) where T : struct =>
//             value.HasValue ? FromStruct(value.GetValueOrDefault()) : AqValue.Null;
//
//         /// <summary>
//         /// Creates value containing new <see cref="PhpAlias"/> pointing to <c>NULL</c> value.
//         /// </summary>
//         public static AqValue CreateAlias() => CreateAlias(Null);
//
//         /// <summary>
//         /// Creates value containing new <see cref="PhpAlias"/>.
//         /// </summary>
//         public static AqValue CreateAlias(AqValue value) => Create(PhpAlias.Create(value));
//
//         public static AqValue Create(IntStringKey value) =>
//             value.IsInteger ? Create(value.Integer) : Create(value.String);
//
//         /// <summary>
//         /// Create <see cref="AqValue"/> representation of <see cref="ulong"/>.
//         /// The value will be converted either to <see cref="long"/> or juggles to <see cref="double"/> if it's larger than long.
//         /// </summary>
//         public static AqValue Create(ulong value)
//         {
...
//         }
//
//         public static AqValue FromClass(object value)
//         {
//             Debug.Assert(!(value is int || value is long || value is bool || value is string || value is double ||
//                            value is PhpAlias || value is PhpString || value is PhpArray || value is PhpString.Blob));
//             return new AqValue(PhpTypeCode.Object, value);
//         }
//
//         public static AqValue FromStruct<TValue>(TValue value) where TValue : struct
//         {
...
//             Debug.Assert(typeof(TValue) != typeof(AqValue));
...
//         /// </summary>
//         public static AqValue FromClr(object value)
//         {
...
//                 if (value.GetType() == typeof(AqValue)) return (AqValue)value;
...
//         /// Implicitly converts a CLR type to PHP type.
//         /// </summary>
//         public static AqValue FromClr(AqValue value) => value;
//
//         /// <summary>
//         /// Converts an array of CLR values to PHP values.
//         /// </summary>
//         public static AqValue[] FromClr(params object[] values)
//         {
...
//
//             //
//             var result = new AqValue[values.Length];

...
//
//         public BlobChar(byte b) : this()
//         {
//             _b = b;
//         }
//
//         public BlobChar(char c) : this()
//         {
//             _ch = c;
//             _b = -1;
//         }
...
//         /// </summary>
//         public static PhpString Substring(this PhpString str, int startIndex) =>
//             Substring(str, startIndex, int.MaxValue);
//
//         /// <summary>
//         /// Gets substring of this instance.
//         /// The operation safely maintains single byte and unicode characters, and reuses existing underlaying chunks of text.
...
//             str.SubstringInternal(startIndex, length);
//
//         /// <summary>
...
//     [DebuggerDisplay("{ToString()}", Type = AqVariable.TypeNameString)]
...
//
//                 _flags |= (value._flags &
//                            (Flags.ContainsBinary | Flags.ContainsMutables)); // maintain the binary data flag
//             }
//
...
//                         break;
//                     case char[] carr:
//                         ctx.Output.Write(carr);
//                         break;
//                     case BlobChar[] barr:
//                         WriteChunkAsync(ctx, barr).GetAwaiter().GetResult();
//                         break;
...
//             /// </summary>
//             void IPhpArray.AddValue(PhpValue value)
//             {
//                 throw new NotSupportedException();
//             }
//
...
//             /// </summary>
//             void IPhpArray.RemoveKey(IntStringKey key)
//             {
//                 throw new NotSupportedException();
//             }
//
...
//             /// </summary>
//             PhpAlias IPhpArray.EnsureItemAlias(IntStringKey key)
//             {
//                 throw new NotSupportedException();
//             }
//
...
//             /// </summary>
//             object IPhpArray.EnsureItemObject(IntStringKey key)
//             {
//                 throw new NotSupportedException();
//             }
//
...
//             /// </summary>
//             IPhpArray IPhpArray.EnsureItemArray(IntStringKey key)
//             {
//                 throw new NotSupportedException();
//             }
//
...
//
//         public bool ToBoolean() =>
//             _data != null && (_data is Blob b ? b.ToBoolean() : Convert.ToBoolean((string)_data));
//
//         public double ToDouble() => Convert.StringToDouble(ToString());
//
//         public long ToLong() => Convert.ToLong(ToString());
//
//         public Convert.NumberInfo ToNumber(out AqNumber number) => Convert.ToNumber(ToString(), out number);
//
...
//         /// </summary>
//         public static Blob /*!*/ AsArray(PhpString str) =>
//             str._data is Blob b ? b : str._data is string s ? new Blob(s) : new Blob(); // TODO: can be removed (?)
//
//         /// <summary>
...
//
//         public string ToString(Encoding encoding) =>
//             _data is Blob b ? b.ToString(encoding) : _data is string str ? str : string.Empty;
//
//         public byte[] ToBytes(Context ctx) => ToBytes(ctx.StringEncoding);
//
//         public byte[] ToBytes(Encoding encoding) =>
...
//                         : ArrayUtils.EmptyBytes;
//
//         public AqNumber ToNumber()
//         {
//             double d;
//             long l;
//             var info = Convert.StringToNumber(ToString(), out l, out d);
//             return (info & Convert.NumberInfo.Double) != 0 ? AqNumber.Create(d) : AqNumber.Create(l);
//         }
//     }
// }

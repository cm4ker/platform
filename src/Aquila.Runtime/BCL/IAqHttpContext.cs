...
namespace Aquila.Core
{
    ...
    public interface IAqHttpContext
    {
        ...
        /// </summary>
        void AddCookie(string name, string value, DateTimeOffset? expires, string path = "/", string? domain = null,
            bool secure = false, bool httpOnly = false, string? samesite /*none|lax|strict*/ = null);

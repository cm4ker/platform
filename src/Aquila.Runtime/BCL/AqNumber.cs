...
//     public readonly struct AqNumber : IComparable<AqNumber>, IComparable<long>, IComparable<double>,
//         IEquatable<AqNumber>
//     {
...
//         /// Number type.
//         /// </summary>
//         [FieldOffset(0)] readonly NumberType _type;
//
//         [FieldOffset(4)] readonly long _long;
//
//         [FieldOffset(4)] readonly double _double;
//
//         #endregion
//
//         #region Properties
...
//         {
//             get { return IsLong ? AqVariable.TypeNameInteger : AqVariable.TypeNameDouble; }
//         }
//
//         #endregion
//
...
//         /// </summary>
//         public bool Equals(AqNumber other) => other._long == _long && other._type == _type; // <=> tmp.Double == Double
//
//         /// <summary>
//         /// Gets non strict comparison with another number.
//         /// </summary>
//         public int CompareTo(AqNumber other)
//         {
...
//         }
//
//         public static bool operator <(AqNumber x, AqNumber y)
//         {
...
//         }
//
//         public static bool operator <(AqNumber x, double dy)
//         {
...
//         }
//
//         public static bool operator <(AqNumber x, long ly)
//         {
...
//         }
//
//         public static bool operator <(long lx, AqNumber y)
//         {
...
//         /// </summary>
//         public static bool operator ==(AqNumber a, PhpValue b) => Comparison.Compare(a, b) == 0;
//
//         /// <summary>
...
//         /// Non strict equality operator.
//         /// </summary>
//         public static bool operator ==(AqNumber a, AqNumber b)
//         {
//             if (a._type == b._type)
//             {
...
//         /// Non strict equality operator.
//         /// </summary>
//         public static bool operator ==(AqNumber x, long y)
...
//         /// Non strict equality operator.
//         /// </summary>
//         public static bool operator ==(AqNumber x, double y)
//             => x.ToDouble() == y;
//
//         /// <summary>
//         /// Non strict equality operator.
...
//         /// <returns></returns>
//         public static AqNumber operator +(AqNumber x, AqNumber y)
//         {
...
//         /// <returns></returns>
//         public static double operator +(AqNumber x, double dy)
//         {
//             // at least one operand is a double:
//             return x.ToDouble() + dy;
//         }
...
//         /// <returns></returns>
//         public static AqNumber operator +(AqNumber x, long ly)
//         {
//             // at least one operand is a double:
//             if (x.IsDouble)
//             {
...
//         /// <param name="y">Second operand.</param>
//         /// <returns></returns>
//         public static double operator +(double dx, AqNumber y)
//         {
//             // at least one operand is a double:
//             // DOUBLE + DOUBLE|LONG
...
//         /// <param name="y">Second operand.</param>
//         /// <returns></returns>
//         public static AqNumber operator +(long lx, AqNumber y)
//         {
//             // at least one operand is a double:
//             if (y.IsDouble)
//             {
...
//         /// Implements <c>+</c> operator on numbers.
//         /// </summary>
//         public static AqNumber operator +(PhpValue x, AqNumber y)
//         {
...
//         /// Implements <c>+</c> operator on numbers.
//         /// </summary>
//         public static AqNumber operator +(AqNumber x, PhpValue y)
//         {
...
//         /// <param name="y">Second operand.</param>
//         /// <returns></returns>
//         public static AqNumber Add(long x, long y)
//         {
//             // LONG + LONG
//             long rl = unchecked(x + y);
//
//             if ((x & Operators.LONG_SIGN_MASK) != (rl & Operators.LONG_SIGN_MASK) && // result has different sign than x
//                 (x & Operators.LONG_SIGN_MASK) ==
//                 (y & Operators.LONG_SIGN_MASK) // x and y have the same sign                
//             )
//             {
//                 // overflow to double:
//                 return AqNumber.Create((double)x + (double)y);
//             }
//             else
//             {
//                 // long:
//                 return AqNumber.Create(rl); // note: most common case
//             }
//         }
//
//         /// <summary>
...
//         /// Implements <c>+</c> operator on numbers.
//         /// </summary>
//         public static AqNumber Add(PhpValue x, long y)
//         {
//             var x_info = x.ToNumber(out var x_number);
//             if ((x_info & (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
...
//         /// Implements <c>+</c> operator on numbers.
//         /// </summary>
//         public static AqNumber Add(long x, PhpValue y)
//         {
...
//             if (((x.ToNumber(out var xnumber) | y.ToNumber(out var ynumber)) &
//                  (Convert.NumberInfo.IsPhpArray | Convert.NumberInfo.Unconvertible)) != 0)
//             {
...
//         /// Subtract operator.
//         /// </summary>
//         public static AqNumber Sub(long lx, long ly)
//         {
//             long rl = unchecked(lx - ly);
//
//             if ((lx & Operators.LONG_SIGN_MASK) !=
//                 (rl & Operators.LONG_SIGN_MASK) && // result has different sign than x
//                 (lx & Operators.LONG_SIGN_MASK) !=
//                 (ly & Operators.LONG_SIGN_MASK) // x and y have the same sign                
//             )
//             {
//                 // overflow:
...
//         /// Subtract operator.
//         /// </summary>
//         public static double Sub(AqNumber x, double dy)
//         {
//             return x.ToDouble() - dy;
//         }
//
...
//         /// Subtract operator.
//         /// </summary>
//         public static AqNumber Sub(PhpValue x, long ly)
//         {
//             AqNumber x_number;
//
...
//         /// Subtract operator.
//         /// </summary>
//         public static AqNumber Sub(PhpValue x, AqNumber y)
//         {
//             AqNumber x_number;
//
//             var x_info = x.ToNumber(out x_number);
...
//         /// Implements <c>-</c> operator on numbers.
//         /// </summary>
//         public static AqNumber Sub(AqNumber x, PhpValue y)
//         {
//             AqNumber y_number;
//
//             var y_info = y.ToNumber(out y_number);
...
//         /// Subtract operator.
//         /// </summary>
//         public static AqNumber Sub(PhpValue x, PhpValue y)
//         {
//             AqNumber xnumber, ynumber;
//
//             // converts x and y to numbers:
//             if (((x.ToNumber(out xnumber) | y.ToNumber(out ynumber)) &
//                  (Convert.NumberInfo.IsPhpArray | Convert.NumberInfo.Unconvertible)) != 0)
//             {
//                 throw new ArgumentException();
//             }
...
//         /// Subtract operator.
//         /// </summary>
//         public static AqNumber Sub(long lx, PhpValue y)
//         {
//             AqNumber ynumber;
//
//             // converts x and y to numbers:
...
//         /// </summary>
//         public static AqNumber Minus(long lx)
//         {
//             if (lx == long.MinValue)
...
//         /// </summary>
//         public static AqNumber operator -(AqNumber x)
//         {
//             if (x.IsDouble)
//             {
...
//         /// </summary>
//         public static AqNumber Multiply(long lx, long ly)
//         {
...
//         /// Multiply operator.
//         /// </summary>
//         public static AqNumber Multiply(long lx, PhpValue y)
//         {
//             AqNumber ynumber;
//             if ((y.ToNumber(out ynumber) & (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
...
//         /// Multiply operator.
//         /// </summary>
//         public static AqNumber Multiply(PhpValue x, PhpValue y)
//         {
//             AqNumber xnumber, ynumber;
//             if (((x.ToNumber(out xnumber) | y.ToNumber(out ynumber)) &
//                  (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
//                 //PhpException.UnsupportedOperandTypes();
//                 //return 0.0;
//                 throw new ArgumentException();
...
//         /// Multiply operator.
//         /// </summary>
//         public static AqNumber Multiply(PhpValue x, long ly)
//         {
//             AqNumber xnumber;
//             if (((x.ToNumber(out xnumber)) & (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
...
//         public static AqNumber Pow(PhpValue x, PhpValue y)
//         {
//             AqNumber xnumber, ynumber;
//             if (((x.ToNumber(out xnumber) | y.ToNumber(out ynumber)) &
//                  (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
...
//         public static AqNumber Pow(AqNumber x, AqNumber y) => Pow(ref x, ref y);
//
//         static AqNumber Pow(ref AqNumber x, ref AqNumber y)
//         {
...
//         public static AqNumber Pow(long lbase, long lexp)
//         {
//             if (lexp >= 0)
//             {
...
//         public static AqNumber Pow(long lx, AqNumber y)
//         {
...
//         public static AqNumber Pow(long lx, PhpValue y)
//         {
//             AqNumber ynumber;
//             if ((y.ToNumber(out ynumber) & (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
...
//         public static double Pow(AqNumber x, double dy) => Math.Pow(x.ToDouble(), dy);
//
//         // Pow_number_value = ct.PhpNumber.Method("Pow", ct.PhpNumber, ct.PhpValue);
//         public static AqNumber Pow(AqNumber x, PhpValue y)
//         {
//             AqNumber ynumber;
//             if ((y.ToNumber(out ynumber) & (Convert.NumberInfo.Unconvertible | Convert.NumberInfo.IsPhpArray)) != 0)
//             {
...
//         /// </summary>
//         public static implicit operator long(AqNumber value) => value.ToLong();
//
//         /// <summary>
//         /// Converts given number to <see cref="bool"/>.
//         /// </summary>
//         public static implicit operator bool(AqNumber value) => value.ToBoolean();
//
//         /// <summary>
//         /// Converts given number to <see cref="double"/>.
//         /// </summary>
//         public static implicit operator double(AqNumber value) => value.ToDouble();
//
//         public static implicit operator AqNumber(long value) => Create(value);
//
//         public static implicit operator AqNumber(double value) => Create(value);
//
//         #endregion
//
//         #region Operators
...
//         /// Integer zero number.
//         /// </summary>
//         public readonly static AqNumber Default = new AqNumber(0L);
//
//         private AqNumber(long value) : this()
//         {
//             _type = NumberType.@long;
//             _long = value;
//         }
//
//         private AqNumber(double value) : this()
//         {
//             _type = NumberType.@double;
//             _double = value;
//         }
//
//         public static AqNumber Create(long value) => new AqNumber(value);
//
//         public static AqNumber Create(double value) => new AqNumber(value);
//
//         #endregion
//
//         #region Object
...
//
//         public override bool Equals(object obj) => obj is AqNumber num && Equals(num);
//
//         #endregion
//
...
//         }
//
//         public Convert.NumberInfo ToNumber(out AqNumber number)
//         {
//             number = this;
//
//             return IsLong

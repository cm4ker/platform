...
using FromNode = Aquila.QueryBuilder.Model.FromNode;
using JoinNode = Aquila.QueryBuilder.Model.JoinNode;

namespace Aquila.QueryBuilder.Model
{
    public abstract partial class QuerySyntaxNode : Aquila.QueryBuilder.Common.SqlNode
    {

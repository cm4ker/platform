...
namespace Aquila.SyntaxGenerator.Compiler
{
    public static class AstSyntaxGenerator
    {
        ...
        private static List<FieldDeclarationSyntax> GetPrivateFieldsSyntax(CompilerSyntax syntax)
        {
        ...
        private static MethodDeclarationSyntax GetChildMethod(CompilerSyntax syntax)
        {
            var sb = new StringBuilder("public override IEnumerable<LangElement> GetChildren(){");
            foreach (var arg in syntax.Arguments)
            {

            ...
            using (TextReader tr = new StreamReader(args[0]))
            {
                ...
                var unit = SyntaxFactory.CompilationUnit()
                    .AddUsings(
                        ...
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Aquila.Compiler.Contracts.Symbols")),
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Aquila.Language.Ast")),
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Aquila.Language.Ast.Definitions")),
                        SyntaxFactory.UsingDirective(
                            SyntaxFactory.ParseName("Aquila.Language.Ast.Definitions.Expressions")),
                        SyntaxFactory.UsingDirective(
                            SyntaxFactory.ParseName("Aquila.Language.Ast.Definitions.Statements")),
                        SyntaxFactory.UsingDirective(
                            SyntaxFactory.ParseName("Aquila.Language.Ast.Definitions.Functions")),
                        SyntaxFactory.UsingDirective(

...
public class App : ComponentBase
{
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
        ...
        __builder.AddAttribute(2, "Found", (RenderFragment<RouteData>)((RouteData routeData) =>
            delegate(RenderTreeBuilder __builder2)
            {
        ...
        __builder.AddAttribute(10, "NotFound", (RenderFragment)delegate(RenderTreeBuilder __builder2)
        {
            ...
            __builder2.AddAttribute(12, "ChildContent",
                (RenderFragment)delegate(RenderTreeBuilder __builder3) { __builder3.AddContent(13, "Not found"); });
            __builder2.CloseComponent();
            ...
            __builder2.AddAttribute(17, "ChildContent",
                (RenderFragment)delegate(RenderTreeBuilder __builder3)
                {
...
public class MainLayout : LayoutComponentBase
{
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
        ...
        __builder.AddAttribute(1, "ChildContent",
            (RenderFragment)delegate(RenderTreeBuilder __builder2) { __builder2.AddContent(2, "btest"); });
        __builder.CloseComponent();
        ...
        __builder.AddMarkupContent(14,
            "<div class=\"top-row px-4\" b-lu5l6b0u01><a href=\"https://docs.microsoft.com/aspnet/\" target=\"_blank\" b-lu5l6b0u01>About</a></div>\r\n\r\n        ");
...
public class NavMenu : ComponentBase
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder __builder)
    {
        ...
        __builder.AddAttribute(10, "onclick",
            EventCallback.Factory.Create<MouseEventArgs>(this, new Action(ToggleNavMenu)));
        ...
        __builder.AddAttribute(28, "ChildContent",
            (RenderFragment)delegate(RenderTreeBuilder __builder2)
            {
                __builder2.AddMarkupContent(29,
                    "<span class=\"oi oi-home\" aria-hidden=\"true\" b-clseustna0></span> Home\r\n            ");
            });
        __builder.CloseComponent();
        __builder.CloseElement();
        ...
        __builder.AddAttribute(37, "ChildContent",
            (RenderFragment)delegate(RenderTreeBuilder __builder2)
            {
                __builder2.AddMarkupContent(38,
                    "<span class=\"oi oi-plus\" aria-hidden=\"true\" b-clseustna0></span> Counter\r\n            ");
            });
        __builder.CloseComponent();
        __builder.CloseElement();
        ...
        __builder.AddAttribute(46, "ChildContent",
            (RenderFragment)delegate(RenderTreeBuilder __builder2)
            {
                __builder2.AddMarkupContent(47,
                    "<span class=\"oi oi-list-rich\" aria-hidden=\"true\" b-clseustna0></span> Fetch data\r\n            ");
            });
        __builder.CloseComponent();
        __builder.CloseElement();
        __builder.CloseElement();

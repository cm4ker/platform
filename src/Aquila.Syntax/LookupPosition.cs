...
//         /// </summary>
//         internal static bool IsInBlock(int position, BlockStmt blockOpt)
//         {
...
//         }
//
//         private static bool IsInBody(int position, BlockSyntax blockOpt, ArrowExpressionClauseSyntax exprOpt,
//             SyntaxToken semiOpt)
//         {
...
//         /// </summary>
//         private static bool IsBeforeToken(int position, LangElement node, SyntaxToken firstExcluded)
//         {
...
//         }
//
//         // internal static bool IsInAttributeSpecification(int position,
...
//         //     return typeParameterListOpt != null &&
//         //            IsBeforeToken(position, typeParameterListOpt, typeParameterListOpt.GreaterThanToken);
//         // }
//         //
...
//         //     {
//         //         var nextToken =
//         //             (SyntaxToken) SyntaxNavigator.Instance.GetNextToken(constructorDecl, predicate: null,
//         //                 stepInto: null);
...
//         // }
//
//         internal static bool IsInMethodTypeParameterScope(int position, MethodDecl methodDecl)
//         {
//             Debug.Assert(methodDecl != null);
...
//             if (methodDecl.ReturnType.Span.Contains(position))
//             {
//                 return true;
//             }
//
...
//             // var firstNameToken = explicitInterfaceSpecifier == null
//             //     ? methodDecl.Identifier
//             //     : explicitInterfaceSpecifier.GetFirstToken();
//
//             // var typeParams = methodDecl.TypeParameterList;
//             // var firstPostNameToken =
//             //     typeParams == null ? methodDecl.ParameterList.OpenParenToken : typeParams.LessThanToken;
//
//             // Scope does not include method name.
//             return !IsBetweenTokens(position, null, null);
//         }
//
//         /// <remarks>
...
//         //             return IsBetweenTokens(position, firstIncluded,

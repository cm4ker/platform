...
namespace Aquila.Compiler
{
    public class SyntaxTreeMemberAccessProvider
    {
        ...
        private Dictionary<string, List<PProperty>> _props;
        private Dictionary<string, List<PMethod>> _methods;
        private TypeManager _ts;

        public SyntaxTreeMemberAccessProvider(Root root, TypeManager ts)
        {
            _cu = root.Units;
            _root = root;
            ...
            _props = new Dictionary<string, List<PProperty>>();
            _methods = new Dictionary<string, List<PMethod>>();

            RegisterStatic();
        }

        public PType GetClrType(TypeSyntax typeSyntax)
        {
            ...
            {
                PType[] args = new PType[gts.Args.Count];
        ...
        public PType GetClrType(SingleTypeSyntax type)
        {

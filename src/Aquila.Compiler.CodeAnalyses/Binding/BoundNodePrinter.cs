...
//         {
//             writer.WriteKeyword(node.Local.IsReadOnly ? SyntaxKind.LetKeyword : SyntaxKind.VarKeyword);
//             writer.WriteSpace();
//             writer.WriteIdentifier(node.Local.Name);
//             writer.WriteSpace();
...
//
//             // if (node.NamedType == NamedTypeSymbol.Bool)
//             // {
//             //     writer.WriteKeyword((bool)node.Value ? SyntaxKind.TrueKeyword : SyntaxKind.FalseKeyword);
//             // }
//             // else if (node.NamedType == NamedTypeSymbol.Int)
//             // {
//             //     writer.WriteNumber(value);
//             // }
//             // else if (node.NamedType == NamedTypeSymbol.String)
//             // {
//             //     value = "\"" + value.Replace("\"", "\"\"") + "\"";
...
//             // else
//             // {
//             //     throw new Exception($"Unexpected type {node.NamedType}");
//             // }
//         }
//
...
//         {
//             writer.WriteIdentifier(node.NamedType.Name);
//             writer.WritePunctuation(SyntaxKind.OpenParenthesisToken);
//             node.Expression.WriteTo(writer);
//             writer.WritePunctuation(SyntaxKind.CloseParenthesisToken);
//         }

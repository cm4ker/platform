...
namespace Aquila.Language.Ast.Binding
{
    internal abstract class BoundTreeRewriter
    {
        ...
        protected virtual BoundStatement RewriteVariableDeclaration(BoundVariableDeclaration node)
        {
            ...
            return new BoundVariableDeclaration(node.Syntax, node.Local, initializer);
        }
        ...
        protected virtual BoundStatement RewriteForStatement(BoundForStatement node)
        {
            ...
            return new BoundForStatement(node.Syntax, node.Local, lowerBound, upperBound, body, node.BreakLabel, node.ContinueLabel);
        }
        ...
        protected virtual BoundExpression RewriteAssignmentExpression(BoundAssignmentExpression node)
        {
            ...
            return new BoundAssignmentExpression(node.Syntax, node.Local, expression);
        }
        ...
        protected virtual BoundExpression RewriteConversionExpression(BoundConversionExpression node)
        {
            ...
            return new BoundConversionExpression(node.Syntax, node.NamedType, expression);
        }
    }
}

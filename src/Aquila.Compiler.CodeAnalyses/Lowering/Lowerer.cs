...
namespace Aquila.Language.Ast.Lowering
{
    internal sealed class Lowerer : BoundTreeRewriter
    {
        ...
        public static BoundBlockStatement Lower(MethodSymbol method, BoundStatement statement)
        {
            var lowerer = new Lowerer();
            var result = lowerer.RewriteStatement(statement);
            return RemoveDeadCode(Flatten(method, result));
        }
        ...
        private static BoundBlockStatement Flatten(MethodSymbol method, BoundStatement statement)
        {
            ...
            if (method.NamedType.SpecialType == SpecialType.System_Void)
            {

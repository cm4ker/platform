...
namespace Aquila.Language.Ast
{
    public sealed class SyntaxTree
    {
        ...
        //     out ImmutableArray<Diagnostic> diagnostics, bool includeEndOfFile = false)
        // {
        //     var tokens = new List<SyntaxToken>();
        //
        //     void ParseTokens(SyntaxTree st, out CompilationUnit root, out ImmutableArray<Diagnostic> d)
        //     {
        //         var l = new Lexer(st);
        //         while (true)
        //         {

...
using ArgumentList = Aquila.Language.Ast.ArgumentList;
    ...
    public partial class Generator
    {
        private void EmitCall(RBlockBuilder e, Call call, SymbolTable symbolTable)
        {
            ...
            if (symbol != null)
            {
                ...
                if (call.Arguments == null && method.Parameters == null)
                {
                    // Ugly hack.
                    goto Hack;
                }
                ...
                else
                {
                    ...
                    {
                        if (call.Arguments[x].PassMethod != method.Parameters[x].PassMethod)
                        {

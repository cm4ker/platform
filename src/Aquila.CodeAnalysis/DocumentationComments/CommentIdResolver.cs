 ...
 namespace Aquila.CodeAnalysis.DocumentationComments
{
    internal static class CommentIdResolver
    {
        ...
        public static string GetId(MethodSymbol method) => "M:" + TypeId(method.ContainingType) + "." + MethodSignatureId(method);
        ...
        static string MethodSignatureId(MethodSymbol method)
        {
            var builder = new StringBuilder();

            builder.Append(GetEscapedMetadataName(method.MetadataName));
            AppendParameters(method.Parameters, method.IsVararg, builder);

 ...
 namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        /// </returns>
        internal TypeSymbol BindTypeOrVarKeyword(TypeRef syntax, DiagnosticBag diagnostics, out bool isVar)
        {
        ...
        private Symbol BindTypeOrAliasOrVarKeyword(TypeRef syntax, DiagnosticBag diagnostics, out bool isVar)
        {
            if (syntax.IsVar)
            {
        ...
        internal static NamedTypeSymbol GetSpecialType(AquilaCompilation compilation, SpecialType typeId, SyntaxNode node, DiagnosticBag diagnostics)
        {
        ...
        internal static bool TryGetSpecialTypeMember<TSymbol>(AquilaCompilation compilation, SpecialMember specialMember, SyntaxNode syntax, DiagnosticBag diagnostics, out TSymbol symbol)
        ...
        internal static Symbol GetWellKnownTypeMember(AquilaCompilation compilation, WellKnownMember member, DiagnosticBag diagnostics, Location location = null, SyntaxNode syntax = null, bool isOptional = false)
        {
        ...
        internal static Symbol GetWellKnownTypeMember(AquilaCompilation compilation, WellKnownMember member, out DiagnosticInfo diagnosticInfo, bool isOptional = false)
        {
        ...
        private static BestSymbolLocation GetLocation(AquilaCompilation compilation, Symbol symbol)
        {

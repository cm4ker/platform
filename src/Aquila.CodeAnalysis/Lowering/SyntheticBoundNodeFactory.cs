...
//         }
//
//         public AquilaCompilation Compilation { get { return CompilationState.Compilation; } }
...
//                 args,
//                 diagnostics,
//                 typeArgs: typeArgs.IsDefault ? default(ImmutableArray<TypeWithAnnotations>) : EnumerableExtensions.SelectAsArray(typeArgs, t => TypeWithAnnotations.Create(t)),
...
//         {
//             Debug.Assert(left.Type?.SpecialType == Microsoft.CodeAnalysis.SpecialType.System_Boolean);
//             Debug.Assert(right.Type?.SpecialType == Microsoft.CodeAnalysis.SpecialType.System_Boolean);
...
//             switch (input.Type)
//             {
//                 case { SpecialType: Microsoft.CodeAnalysis.SpecialType.System_Double }:
//                     // produce double.IsNaN(input)
//                     return StaticCall(Microsoft.CodeAnalysis.SpecialMember.System_Double__IsNaN, input);
//                 case { SpecialType: Microsoft.CodeAnalysis.SpecialType.System_Single }:
...
//         {
//             Debug.Assert(ex.Type is { SpecialType: Microsoft.CodeAnalysis.SpecialType.System_Int32 });
//
...
//         }
//
//         public BoundStatement SequencePointWithSpan(AquilaSyntaxNode syntax, TextSpan span, BoundStatement statement)
//         {
...
//                 Syntax,
//                 Type(type),
//                 WellKnownMethod(Microsoft.CodeAnalysis.WellKnownMember.System_Type__GetTypeFromHandle),
//                 WellKnownType(Microsoft.CodeAnalysis.WellKnownType.System_Type))
//             { WasCompilerGenerated = true };
//         }
//
...
//         {
//             return EnumerableExtensions.SelectAsArray(typeArguments, Typeof);
//         }
//
...
//         /// </summary>
//         public BoundExpression SourceDocumentIndex(Microsoft.Cci.DebugSourceDocument document)
//         {
...
//             if (!method.ContainingType.IsValueType || !Aquila.CodeAnalysis.CodeGen.CodeGenerator.MayUseCallForStructMethod(method))
//             {
...
//                 return this.Call(arg, this.SpecialMethod(Microsoft.CodeAnalysis.SpecialMember.System_Nullable_T_get_Value).AsMember((NamedTypeSymbol)arg.Type));
//             }
//
...
//             {
//                 MethodSymbol? arrayEmpty = WellKnownMethod(Microsoft.CodeAnalysis.WellKnownMember.System_Array__Empty, isOptional: true);
//                 if (arrayEmpty is { })
//                 {
...
//         {
//             Debug.Assert(expression is { Type: { SpecialType: Microsoft.CodeAnalysis.SpecialType.System_Boolean } });

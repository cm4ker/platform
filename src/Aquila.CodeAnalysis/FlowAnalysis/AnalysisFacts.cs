...
namespace Pchp.CodeAnalysis.FlowAnalysis
{
    static class AnalysisFacts
    {
        ...
        static bool IsUnconditionalDeclaration(IPhpRoutineSymbol symbol)
        {
            ...
            if (symbol is PEMethodSymbol method)
            {
                ...
                return container != null &&
                       !container.IsPhpSourceFile(); // only functions declared in libraries, not in PHP source file
            }
        ...
        {
            HandleTypeCheckingExpression(varRef, (var) => targetType, branch, flowState, skipPositiveIfAnyType,
                checkExpr, isPositiveCheck);
        }
            ...
            bool isPositiveCheck = true)
        {
            ...
            bool isFeasible = HandleTypeChecking(currentType, targetType, branchHlp, flowState, handle,
        ...
        private static bool TryGetVariableHandle(IVariableReference boundvar, FlowState state,

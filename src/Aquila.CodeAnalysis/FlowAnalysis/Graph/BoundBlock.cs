...
namespace Aquila.CodeAnalysis.Semantics.Graph
{
    ...
    partial class ExitBlock
    {
        ...
        /// <summary>
        /// Subscribe a block to be analysed when the exit block is reached and the method return value changes.
        /// </summary>
        ...
        internal ICollection<BoundBlock> Subscribers =>
            (ICollection<BoundBlock>) _subscribers ?? Array.Empty<BoundBlock>();

        /// <summary>
        /// Set of blocks making call to this method (callers) (may be from another CFG) waiting for return type of this method.
        /// </summary>

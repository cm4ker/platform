    ...
    internal static class ObsoleteAttributeHelpers
    {
        ...
        internal static DiagnosticInfo CreateObsoleteDiagnostic(Symbol symbol, BinderFlags location)
        {
            ...
            var errorCode = (message: data.Message, isError: data.IsError, isColInit) switch
            {
                ...
                (Item1: null, Item2: _, Item3: true) => ErrorCode.WRN_DeprecatedCollectionInitAdd,
                (Item1: null, Item2: _, Item3: false) => ErrorCode.WRN_DeprecatedSymbol,
                (Item1: { }, Item2: true, Item3: true) => ErrorCode.ERR_DeprecatedCollectionInitAddStr,
                (Item1: { }, Item2: true, Item3: false) => ErrorCode.ERR_DeprecatedSymbolStr,
                (Item1: { }, Item2: false, Item3: true) => ErrorCode.WRN_DeprecatedCollectionInitAddStr,
                (Item1: { }, Item2: false, Item3: false) => ErrorCode.WRN_DeprecatedSymbolStr
            };

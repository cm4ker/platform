...
namespace Aquila.CodeAnalysis.Symbols
{
    internal abstract class AssemblySymbol : Symbol, IAssemblySymbol, IAssemblySymbolInternal
    {
        ...
        internal virtual ImmutableArray<byte> PublicKey
        {
        ...
        public virtual NamedTypeSymbol GetTypeByMetadataName(string fullyQualifiedMetadataName)
        {
            ...
            return this.GetTypeByMetadataName(fullyQualifiedMetadataName, includeReferences: false,
            ...
            DiagnosticBag warnings = null)
        {
            ...
            else
            {
                ...
                if (includeReferences && (type == null || type.IsErrorType()))
                {
                    ...
                    assemblies.UnionWith(this.DeclaringCompilation.GetBoundReferenceManager().GetReferencedAssemblies()
                        .Select(x => (AssemblySymbol) x.Value));
        ...
        internal virtual Symbol GetDeclaredSpecialTypeMember(SpecialMember member)
        {
                ...
                ErrorTypeSymbol.UnknownResultType))
            {
                ...
                if (!type.IsErrorType())
                {
                    result = PhpCompilation.GetRuntimeMember(type, ref descriptor,
                        PhpCompilation.SpecialMembersSignatureComparer.Instance, null);
                }
        ...
        /// </param>
        /// <remarks></remarks>
        internal NamedTypeSymbol LookupTopLevelMetadataType(ref MetadataTypeName emittedName,
            bool digThroughForwardedTypes)
        {
            return LookupTopLevelMetadataTypeWithCycleDetection(ref emittedName, visitedAssemblies: null,
                digThroughForwardedTypes: digThroughForwardedTypes);
        }
        ...
        /// Take forwarded types into account.
        /// </param>
        internal abstract NamedTypeSymbol LookupTopLevelMetadataTypeWithCycleDetection(ref MetadataTypeName emittedName,
            ConsList<AssemblySymbol> visitedAssemblies, bool digThroughForwardedTypes);

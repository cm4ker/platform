...
#nullable enable
 ...
 namespace Aquila.CodeAnalysis.Symbols.FunctionPointers
{
    internal sealed partial class FunctionPointerTypeSymbol : TypeSymbol
    {
        ...
        public static FunctionPointerTypeSymbol CreateFromMetadata(Microsoft.Cci.CallingConvention callingConvention, ImmutableArray<ParamInfo<TypeSymbol>> retAndParamTypes)
            => new FunctionPointerTypeSymbol(

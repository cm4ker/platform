...
namespace Aquila.CodeAnalysis.Symbols.Synthesized
{
    ...
    internal class SynthesizedPhpCtorSymbol : SynthesizedMethodSymbol
    {
        ...
        // protected SynthesizedPhpCtorSymbol(Source.SourceTypeSymbol containingType, Accessibility accessibility,
        ...
        public SynthesizedPhpCtorSymbol(ITypeDefinition containingType, ModuleSymbol module, string name, bool isstatic, bool isvirtual, TypeSymbol returnType, Accessibility accessibility = Accessibility.Private, bool isfinal = true, bool isabstract = false) : base(containingType, module, name, isstatic, isvirtual, returnType, accessibility, isfinal, isabstract)
        {
        }

        public SynthesizedPhpCtorSymbol(TypeSymbol containingType, string name, bool isstatic, bool isvirtual, TypeSymbol returnType, Accessibility accessibility = Accessibility.Private, bool isfinal = true, bool isabstract = false, bool phphidden = false, params ParameterSymbol[] ps) : base(containingType, name, isstatic, isvirtual, returnType, accessibility, isfinal, isabstract, phphidden, ps)
        {
        }
    }

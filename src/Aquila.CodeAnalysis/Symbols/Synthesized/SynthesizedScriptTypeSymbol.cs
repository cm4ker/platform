...
namespace Aquila.CodeAnalysis.Symbols.Synthesized
{
    ...
    /// </summary>
    class SynthesizedEntryPointTypeSymbol : NamedTypeSymbol
    {
        ...
        public SynthesizedEntryPointTypeSymbol(AquilaCompilation compilation)
        {
        ...
        public override string Name => WellKnownAquilaNames.DefaultEntryPointClassName;

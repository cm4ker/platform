 ...
 namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal class SynthesizedStaticLocHolder : NamedTypeSymbol
    {
        ...
        public void EmitCtor(PEModuleBuilder module, Action<Microsoft.CodeAnalysis.CodeGen.ILBuilder> builder)
        {
            ...
            var body = MethodGenerator.GenerateMethodBody(module, _ctor, builder, null, DiagnosticBag.GetInstance(), false);
            module.SetMethodBody(_ctor, body);
        }
        SynthesizedCtorSymbol _ctor;

        public void EmitInit(PEModuleBuilder module, Action<Microsoft.CodeAnalysis.CodeGen.ILBuilder> builder)
        {
            ...
            var body = MethodGenerator.GenerateMethodBody(module, _initMethod, builder, null, DiagnosticBag.GetInstance(), false);

...
namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal readonly struct TypeWithState
    {
        ...
        public TypeWithAnnotations ToTypeWithAnnotations(AquilaCompilation compilation, bool asAnnotatedType = false)
        {
        ...
        public TypeWithAnnotations ToAnnotatedTypeWithAnnotations(AquilaCompilation compilation) =>

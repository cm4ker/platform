...
#nullable enable
 ...
 using Aquila.CodeAnalysis.Symbols.Synthesized.Records;
 ...
 namespace Aquila.CodeAnalysis.Symbols.Source
{
    ...
    internal abstract partial class SourceMemberContainerTypeSymbol : NamedTypeSymbol
    {
        ...
        internal SourceMemberContainerTypeSymbol(
            ...
            Tuples.NamedTypeSymbol.TupleExtraData? tupleData = null)
            : base(tupleData)
        {
        ...
        private Dictionary<string, ImmutableArray<Symbol>> GetEarlyAttributeDecodingMembersDictionary()
        {
            if (_lazyEarlyAttributeDecodingMembersDictionary == null)
            {
                ...
                var membersByName = ImmutableArrayExtensions.ToDictionary(membersAndInitializers.NonTypeNonIndexerMembers, s => s.Name);

 ...
 namespace Aquila.CodeAnalysis.Symbols.Source
{
    ...
    internal sealed partial class SourceNamedTypeSymbol : SourceMemberContainerTypeSymbol, IAttributeTargetSymbol
    {
        ...
        internal SourceNamedTypeSymbol(NamespaceOrTypeSymbol containingSymbol, MergedTypeDeclaration declaration, DiagnosticBag diagnostics, Tuples.NamedTypeSymbol.TupleExtraData tupleData = null)

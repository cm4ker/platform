...
// See the LICENSE file in the project root for more information.
 ...
 using CommonAssemblyWellKnownAttributeData = Microsoft.CodeAnalysis.CommonAssemblyWellKnownAttributeData<Aquila.CodeAnalysis.Symbols.NamedTypeSymbol>;
            ...
            if (_compilation.Options.AllowUnsafe)
            {
                    ...
                    !(_compilation.GetWellKnownType(WellKnownType.System_Security_Permissions_SecurityPermissionAttribute) is MissingMetadataTypeSymbol))
                {
                    ...
                    if (!(securityActionType is MissingMetadataTypeSymbol))
                    {
                        ...
                        if (attribute != null)
                        {
                            yield return new Microsoft.Cci.SecurityAttribute((DeclarativeSecurityAction)(int)constantValue, attribute);
                        }
                    }
                }
            }
        ...
        internal override void AddSynthesizedAttributes(PEModuleBuilder moduleBuilder, ref ArrayBuilder<SynthesizedAttributeData> attributes)
        {
            ...
            if (emitCompilationRelaxationsAttribute)
            {
                ...
                if (!(_compilation.GetWellKnownType(WellKnownType.System_Runtime_CompilerServices_CompilationRelaxationsAttribute) is MissingMetadataTypeSymbol))
                {
                    ...
                    var typedConstantNoStringInterning = new TypedConstant(int32Type, TypedConstantKind.Primitive, Microsoft.Cci.Constants.CompilationRelaxations_NoStringInterning);

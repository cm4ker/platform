...
#nullable enable
        private void DecodeDllImportAttribute(ref DecodeWellKnownAttributeArguments<AttributeSyntax, CSharpAttributeData, AttributeLocation> arguments)
        {
            ...
            CharSet charSet = this.GetEffectiveDefaultMarshallingCharSet() ?? Microsoft.Cci.Constants.CharSet_None;
...
#nullable restore
        ...
        internal override IEnumerable<Microsoft.Cci.SecurityAttribute> GetSecurityInformation()
        {
            ...
            return SpecializedCollections.EmptyEnumerable<Microsoft.Cci.SecurityAttribute>();
        }

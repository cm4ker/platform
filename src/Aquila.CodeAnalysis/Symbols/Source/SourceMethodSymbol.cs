...
namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal partial class SourceMethodSymbol : SourceRoutineSymbol
    {
        ...
        internal override SourceFileSymbol ContainingFile => null; //_type.ContainingFile;

        public override string Name => _syntax.Identifier.Text;

        public override Symbol ContainingSymbol => null; //_type;
        ...
        public override bool IsStatic => false; //_syntax.Modifiers.IsStatic();

...
using System.Diagnostics;
 ...
 using Symbol = Pchp.CodeAnalysis.Symbol;
 ...
 namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal partial class SourceMethodSymbol : SourceRoutineSymbol
    {
        ...
        public override void GetDiagnostics(DiagnosticBag diagnostic)
        {
            ...
            if (name.Value.StartsWith("__", StringComparison.Ordinal))
            {
                ...
                if (name.IsConstructName) // __construct()
                {
                    ...
                    if (_syntax.ReturnType != null)
                    {
                        ...
                        diagnostic.Add(this, _syntax.ReturnType.Span.ToTextSpan(), ErrorCode.ERR_CannotDeclareReturnType, "Constructor " + _type.FullName.ToString(name, false));
                    }
                }
                else if (name.IsDestructName)    // __destruct()
                {
                    diagnostic.Add(this, NameSpan, ErrorCode.INF_DestructDiscouraged);
                    ...
                    {
                        // {0} cannot declare a return type
                        diagnostic.Add(this, _syntax.ReturnType.Span.ToTextSpan(), ErrorCode.ERR_CannotDeclareReturnType, "Destructor " + _type.FullName.ToString(name, false));
                    }
                }
                ...
                else if (name.IsCloneName)  // __clone()
                {
                    ...
                    {
                        // {0} cannot declare a return type
                        diagnostic.Add(this, _syntax.ReturnType.Span.ToTextSpan(), ErrorCode.ERR_CannotDeclareReturnType, _type.FullName.ToString(name, false));
                    }
                }
                else if (name.IsCallName) // __call($name, $args)
                {
                    ...
                    {
                        diagnostic.Add(this, _syntax.Signature.Span.ToTextSpan(), ErrorCode.ERR_MustTakeArgs, "Method", _type.FullName.ToString(name, false), 2);
                    }
                }
                ...
                else if (name == Devsense.PHP.Syntax.Name.SpecialMethodNames.Get)   // __get($name)
                {
                    ...
                    {
                        diagnostic.Add(this, _syntax.Signature.Span.ToTextSpan(), ErrorCode.ERR_MustTakeArgs, "Method", _type.FullName.ToString(name, false), 1);
                    }
                }
            ...
            {
                diagnostic.Add(this, NameSpan, ErrorCode.INF_OverrideNameCaseMismatch, Name, OverriddenMethod.Name);
            }

...
// See the LICENSE file in the project root for more information.
 ...
 namespace Aquila.CodeAnalysis.Symbols.Wrapped
{
    /// <summary>
    ...
    internal abstract class WrappedNamedTypeSymbol : NamedTypeSymbol
    {
        ...
        public WrappedNamedTypeSymbol(NamedTypeSymbol underlyingType, Tuples.NamedTypeSymbol.TupleExtraData tupleData)
            : base(tupleData)
        {

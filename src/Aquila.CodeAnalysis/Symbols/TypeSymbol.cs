...
#nullable restore
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToDisplayString((ITypeSymbol)ISymbol, topLevelNullability, format);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToDisplayParts((ITypeSymbol)ISymbol, topLevelNullability, format);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayString((ITypeSymbol)ISymbol, topLevelNullability, semanticModel, position, format);
        }
        ...
        public ImmutableArray<SymbolDisplayPart> ToMinimalDisplayParts(
            ...
            SymbolDisplayFormat format = null)
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayParts((ITypeSymbol)ISymbol, topLevelNullability, semanticModel, position, format);
        }

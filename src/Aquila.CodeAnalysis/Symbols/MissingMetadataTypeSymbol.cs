 ...
 namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal abstract class MissingMetadataTypeSymbol : ErrorTypeSymbol
    {
        ...
        private MissingMetadataTypeSymbol(string name, int arity, bool mangleName, Tuples.NamedTypeSymbol.TupleExtraData? tupleData = null)
            : base(tupleData)
        {
        ...
        internal sealed class TopLevel : MissingMetadataTypeSymbol
        {
            ...
            private TopLevel(ModuleSymbol module, string @namespace, string name, int arity, bool mangleName, bool isNativeInt, DiagnosticInfo? errorInfo, NamespaceSymbol? containingNamespace, int typeId, Tuples.NamedTypeSymbol.TupleExtraData? tupleData)

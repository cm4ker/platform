...
// See the LICENSE file in the project root for more information.
 ...
 using ModuleExtensions = Microsoft.CodeAnalysis.ModuleExtensions;
 ...
 namespace Aquila.CodeAnalysis.Symbols.Metadata.PE
{
    ...
    internal abstract class PENamedTypeSymbol : NamedTypeSymbol
    {
        ...
        private sealed class PENamedTypeSymbolGeneric : PENamedTypeSymbol
        {
            ...
            protected sealed override NamedTypeSymbol WithTupleDataCore(Tuples.NamedTypeSymbol.TupleExtraData newData)
                => throw ExceptionUtilities.Unreachable;

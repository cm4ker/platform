...
namespace Aquila.CodeAnalysis.Symbols.Tuples
{
    ...
    {
        protected readonly Symbols.NamedTypeSymbol _containingTuple;
        ...
        public TupleFieldSymbol(Symbols.NamedTypeSymbol container, FieldSymbol underlyingField, int tupleElementIndex)
        ...
        public override FieldSymbol OriginalDefinition
        {
            get
            {
                Symbols.NamedTypeSymbol originalContainer = ContainingType.OriginalDefinition;
    ...
    internal class TupleElementFieldSymbol : TupleFieldSymbol
    {
        ...
        public TupleElementFieldSymbol(
            Symbols.NamedTypeSymbol container,
        ...
        internal override FieldSymbol AsMember(Symbols.NamedTypeSymbol newOwner)
        {
            Debug.Assert(newOwner.IsTupleType);

            Symbols.NamedTypeSymbol newUnderlyingOwner = GetNewUnderlyingOwner(newOwner);
        ...
        protected Symbols.NamedTypeSymbol GetNewUnderlyingOwner(Symbols.NamedTypeSymbol newOwner)
        {
            int currentIndex = TupleElementIndex;
            Symbols.NamedTypeSymbol newUnderlyingOwner = newOwner;
            while (currentIndex >= NamedTypeSymbol.ValueTupleRestIndex)
            {
                newUnderlyingOwner = (Symbols.NamedTypeSymbol)newUnderlyingOwner.TypeArgumentsWithAnnotationsNoUseSiteDiagnostics[NamedTypeSymbol.ValueTupleRestIndex].Type;

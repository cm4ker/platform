...
namespace Aquila.CodeAnalysis.Symbols.PE
{
    ...
    internal abstract class PENamespaceSymbol : NamespaceSymbol
    {
        ...
        protected void LoadAllMembers(IEnumerable<IGrouping<string, TypeDefinitionHandle>> typesByNS)
        {
            ...
            IEnumerable<KeyValuePair<string, IEnumerable<IGrouping<string, TypeDefinitionHandle>>>> nestedNamespaces =
                null;
                    ...
                    foreach (var t in g)
                    {
                        ...
                        else
                        {
                            try
                            {
                                ...
                                {
                                    noPiaLocalTypes =
                                        new Dictionary<string, TypeDefinitionHandle>(StringOrdinalComparer.Instance);
                                }

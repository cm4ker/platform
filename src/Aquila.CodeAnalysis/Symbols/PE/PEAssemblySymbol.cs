...
namespace Aquila.CodeAnalysis.Symbols.PE
{
    ...
    internal sealed class PEAssemblySymbol : MetadataOrSourceAssemblySymbol
    {
        ...
        /// <summary>
        /// The assembly purpose, and whether the compiler treats it as a .NET reference, Aquila extension or a Cor library.
        /// </summary>
        ...
        internal PEAssemblySymbol(PEAssembly assembly, DocumentationProvider documentationProvider, string filePath,
            bool isLinked, MetadataImportOptions importOptions)
        {
            ...
            if (IsAquilaCoreLib(assembly))
            {
                _specialAssembly = SpecialAssembly.AquilaCorLibrary;
            ...
            else if (IsSystemCollectionImmutableLib(assembly))
            {
            ...
            else if (IsSystemCollections(assembly))
            {
                _specialAssembly = SpecialAssembly.SystemCollections;
            }
            ...
            bool isLinked = true)
        {
            ...
            return new PEAssemblySymbol(
                ...
                IsAquilaCoreLib(ass) ? MetadataImportOptions.Internal : MetadataImportOptions.Public);
        }
            ...
            ref MetadataTypeName emittedName, ConsList<AssemblySymbol> visitedAssemblies)
        {
            ...
            if ((object)forwardedToAssembly != null)
            {
                ...
                else
                {
                    ...
                    return forwardedToAssembly.LookupTopLevelMetadataTypeWithCycleDetection(ref emittedName,
                        visitedAssemblies, digThroughForwardedTypes: true);
                }
            }

...
// See the LICENSE file in the project root for more information.
 ...
 namespace Aquila.CodeAnalysis.Symbols.Retargeting
{
    ...
    internal partial class RetargetingModuleSymbol
    {
            ...
            : CSharpSymbolVisitor<RetargetOptions, Symbol>
        {
            ...
            {
                Debug.Assert(symbol.Kind != SymbolKind.NamedType || ((NamedTypeSymbol)symbol).PrimitiveTypeCode == Microsoft.Cci.PrimitiveTypeCode.NotPrimitive);
            ...
            private NamedTypeSymbol RetargetNamedTypeDefinition(NamedTypeSymbol type, RetargetOptions options)
            {
                ...
                {
                    Microsoft.Cci.PrimitiveTypeCode typeCode = type.PrimitiveTypeCode;

                    if (typeCode != Microsoft.Cci.PrimitiveTypeCode.NotPrimitive)
                    {
            ...
            public ImmutableArray<NamedTypeSymbol> Retarget(ImmutableArray<NamedTypeSymbol> sequence)
            {
                ...
                foreach (var nts in sequence)
                {
                    ...
                    Debug.Assert(nts.TypeKind == TypeKind.Error || nts.PrimitiveTypeCode == Microsoft.Cci.PrimitiveTypeCode.NotPrimitive);
            ...
            public ImmutableArray<TypeSymbol> Retarget(ImmutableArray<TypeSymbol> sequence)
            {
                ...
                foreach (var ts in sequence)
                {
                    ...
                    Debug.Assert(ts.TypeKind == TypeKind.Error || ts.PrimitiveTypeCode == Microsoft.Cci.PrimitiveTypeCode.NotPrimitive);

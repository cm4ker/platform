 ...
 namespace Aquila.CodeAnalysis.Symbols.Retargeting
{
    ...
    internal sealed class RetargetingNamedTypeSymbol : WrappedNamedTypeSymbol
    {
        ...
        public RetargetingNamedTypeSymbol(RetargetingModuleSymbol retargetingModule, NamedTypeSymbol underlyingType, Tuples.NamedTypeSymbol.TupleExtraData tupleData = null)

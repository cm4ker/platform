...
// See the LICENSE file in the project root for more information.
 ...
 namespace Aquila.CodeAnalysis.Symbols.AnonymousTypes
{
    /// <summary>
    ...
    internal sealed partial class AnonymousTypeManager
    {
        ...
        /// types in emit phase.
        /// </summary>
        private ConcurrentDictionary<string, SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol> _lazyAnonymousTypeTemplates;
        ...
        private struct SynthesizedDelegateValue
        {
            ...
            public readonly SynthesizedSymbols.AnonymousTypeManager Manager;

            public SynthesizedDelegateValue(SynthesizedSymbols.AnonymousTypeManager manager, SynthesizedDelegateSymbol @delegate)
            {
        ...
        [Conditional("DEBUG")]
        private void CheckSourceLocationSeen(PublicSymbols.AnonymousTypeManager.AnonymousTypePublicSymbol anonymous)
        {
#if DEBUG
        ...
        private ConcurrentDictionary<string, SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol> AnonymousTypeTemplates
        {
            get
            {
                ...
                if (_lazyAnonymousTypeTemplates == null)
                {
                    ...
                    Interlocked.CompareExchange(ref _lazyAnonymousTypeTemplates,
                                                previousCache == null
                                                    ? new ConcurrentDictionary<string, SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>()
                                                    : new ConcurrentDictionary<string, SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>(previousCache),
                                                null);
                }
        ...
        /// </summary>
        private NamedTypeSymbol ConstructAnonymousTypeImplementationSymbol(PublicSymbols.AnonymousTypeManager.AnonymousTypePublicSymbol anonymous)
        {
            ...
            SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol template;
            if (!this.AnonymousTypeTemplates.TryGetValue(typeDescr.Key, out template))
            {
                // NOTE: the newly created template may be thrown away if another thread wins
                template = this.AnonymousTypeTemplates.GetOrAdd(typeDescr.Key, new SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol(this, typeDescr));
            }
        ...
        private SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol CreatePlaceholderTemplate(Microsoft.CodeAnalysis.Emit.AnonymousTypeKey key)
        {
            ...
            return new SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol(this, typeDescr);
        }
        ...
        public void AssignTemplatesNamesAndCompile(MethodCompiler compiler, PEModuleBuilder moduleBeingBuilt, DiagnosticBag diagnostics)
        {
            ...
            var builder = ArrayBuilder<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>.GetInstance();
            ...
            if (!this.AreTemplatesSealed)
            {
                ...
                foreach (var template in builder)
                {
                    ...
                    template.NameAndIndex = new SynthesizedSymbols.AnonymousTypeManager.NameAndIndex(name, index);
                }
        ...
        /// </summary>
        private void GetCreatedAnonymousTypeTemplates(ArrayBuilder<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol> builder)
        {
        ...
        internal IReadOnlyDictionary<Microsoft.CodeAnalysis.Emit.AnonymousTypeKey, Microsoft.CodeAnalysis.Emit.AnonymousTypeValue> GetAnonymousTypeMap()
        {
            ...
            var templates = ArrayBuilder<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>.GetInstance();
        ...
        internal ImmutableArray<NamedTypeSymbol> GetAllCreatedTemplates()
        {
            ...
            var anonymousTypes = ArrayBuilder<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>.GetInstance();
        ...
        {
            return type is SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol;
        }
        ...
        internal static ImmutableArray<MethodSymbol> GetAnonymousTypeHiddenMethods(NamedTypeSymbol type)
        {
            ...
            return ((SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol)type).SpecialMembers;
        }
        ...
        internal static NamedTypeSymbol TranslateAnonymousTypeSymbol(NamedTypeSymbol type)
        {
            ...
            var anonymous = (PublicSymbols.AnonymousTypeManager.AnonymousTypePublicSymbol)type;
        ...
        /// </summary>
        private sealed class AnonymousTypeComparer : IComparer<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol>
        {
            ...
            public int Compare(SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol x, SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeTemplateSymbol y)
            {

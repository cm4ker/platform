...
// See the LICENSE file in the project root for more information.
 ...
 namespace Aquila.CodeAnalysis.Symbols.AnonymousTypes.PublicSymbols
{
    internal sealed partial class AnonymousTypeManager
    {
        ...
        internal sealed class AnonymousTypePublicSymbol : NamedTypeSymbol
        {
            ...
            internal readonly ImmutableArray<SynthesizedSymbols.AnonymousTypeManager.AnonymousTypePropertySymbol> Properties;
            ...
            internal readonly SynthesizedSymbols.AnonymousTypeManager Manager;

            /// <summary> Anonymous type descriptor </summary>
            internal readonly AnonymousTypeDescriptor TypeDescriptor;

            internal AnonymousTypePublicSymbol(SynthesizedSymbols.AnonymousTypeManager manager, AnonymousTypeDescriptor typeDescr)
            {
                ...
                var properties = fields.SelectAsArray((field, i, type) => new SynthesizedSymbols.AnonymousTypeManager.AnonymousTypePropertySymbol(type, field, i), this);
                ...
                // Add a constructor
                members.Add(new SynthesizedSymbols.AnonymousTypeManager.AnonymousTypeConstructorSymbol(this, properties));

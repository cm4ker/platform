...
namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal readonly struct TypeWithAnnotations : IFormattable
    {
        ...
        internal static TypeWithAnnotations Create(bool isNullableEnabled, TypeSymbol typeSymbol,
            bool isAnnotated = false)
        {
            ...
            return Create(typeSymbol,
                nullableAnnotation: isAnnotated ? NullableAnnotation.Annotated :
                isNullableEnabled ? NullableAnnotation.NotAnnotated : NullableAnnotation.Oblivious);
        }

        internal static TypeWithAnnotations Create(TypeSymbol typeSymbol,
        ...
        private static TypeWithAnnotations CreateNonLazyType(TypeSymbol typeSymbol,
            NullableAnnotation nullableAnnotation, ImmutableArray<CustomModifier> customModifiers)
        {
            return new TypeWithAnnotations(typeSymbol, nullableAnnotation, Extensions.Create(customModifiers));
        }

        private static TypeWithAnnotations CreateLazyNullableType(AquilaCompilation compilation,
            TypeWithAnnotations underlying)
        {
            return new TypeWithAnnotations(defaultType: underlying.DefaultType,
        ...
        internal bool IsDefault => DefaultType is null && this.NullableAnnotation == 0 &&
                                   (_extensions == null || _extensions == Extensions.Default);
...
#nullable enable
        public TypeWithAnnotations SetIsAnnotated(AquilaCompilation compilation)
        {
            ...
            TypeWithAnnotations makeNullableT()
                => Create(compilation.GetSpecialType(SpecialType.System_Nullable_T)
...
#nullable disable
        ...
        public Microsoft.Cci.PrimitiveTypeCode PrimitiveTypeCode => Type.PrimitiveTypeCode;
        ...
        public bool Equals(TypeWithAnnotations other, TypeCompareKind comparison)
        {
            ...
            if ((comparison & TypeCompareKind.IgnoreNullableModifiersForReferenceTypes) == 0)
            {
                if (otherAnnotation != thisAnnotation &&
                    ((comparison & TypeCompareKind.ObliviousNullableModifierMatchesAny) == 0 ||
                     (!thisAnnotation.IsOblivious() && !otherAnnotation.IsOblivious())))
                {
                    if (!HasType)
                    {
                        return false;
        ...
        internal sealed class EqualsComparer : EqualityComparer<TypeWithAnnotations>
        {
            ...
            internal static readonly EqualsComparer IgnoreNullableModifiersForReferenceTypesComparer =
                new EqualsComparer(TypeCompareKind.IgnoreNullableModifiersForReferenceTypes);
        ...
        public bool GetUnificationUseSiteDiagnosticRecursive(ref DiagnosticInfo result, Symbol owner,
            ref HashSet<TypeSymbol> checkedTypes)
        {
            ...
            //        Symbol.GetUnificationUseSiteDiagnosticRecursive(ref result, this.CustomModifiers, owner,
            //            ref checkedTypes);
        }

        public bool IsAtLeastAsVisibleAs(Symbol sym,
            ref Microsoft.CodeAnalysis.CompoundUseSiteInfo<AssemblySymbol> useSiteInfo)
        {
        ...
        internal TypeWithAnnotations SubstituteTypeCore(AbstractTypeMap typeMap)
        {
            ...
            {
                Debug.Assert(newTypeWithModifiers.NullableAnnotation.IsOblivious() || (typeSymbol.IsNullableType() &&
                ...
                else if ((NullableAnnotation.IsOblivious() ||
        ...
        public TypeWithAnnotations WithTypeAndModifiers(TypeSymbol typeSymbol,
        ...
        /// <summary>
        /// Used by callers before calling AquilaCompilation.EnsureNullableAttributeExists().
        /// </summary>
        /// <remarks>
            ...
            TypeSymbol typeOpt)
        {
            var type = TypeSymbolExtensions.VisitType(
                ...
                typeOpt,
                typeWithAnnotationsPredicate: (t, a, b) =>
                    t.NullableAnnotation != NullableAnnotation.Oblivious && !t.Type.IsErrorType() &&
                    !t.Type.IsValueType,
                typePredicate: null,
                arg: (object)null);
        ...
        private static void AddNullableTransforms(TypeWithAnnotations typeWithAnnotations,
            ArrayBuilder<byte> transforms)
        {
            while (true)
            {
        ...
        public bool ApplyNullableTransforms(byte defaultTransformFlag, ImmutableArray<byte> transforms,
            ref int position, out TypeWithAnnotations result)
        {
            result = this;
            ...
            if (!oldTypeSymbol.ApplyNullableTransforms(defaultTransformFlag, transforms, ref position,
                    out newTypeSymbol))
            {
                return false;
            }
            ...
            switch (transformFlag)
            {
                ...
                case NullableAnnotationExtensions.ObliviousAttributeValue:
                    if (result.NullableAnnotation != NullableAnnotation.Oblivious &&
                        !(result.NullableAnnotation.IsAnnotated() &&
...
#pragma warning restore CS0809
        ...
        internal TypeWithState ToTypeWithState()
        {
            ...
            static NullableFlowState getFlowState(TypeSymbol type, NullableAnnotation annotation)
            {
                ...
                return annotation switch
                {
                    NullableAnnotation.Annotated => NullableFlowState.MaybeNull, _ => NullableFlowState.NotNull
                };
            }
        }
        ...
        private abstract class Extensions
        {
            internal static readonly Extensions Default =
                new NonLazyType(customModifiers: ImmutableArray<CustomModifier>.Empty);
            ...
            internal static Extensions CreateLazy(AquilaCompilation compilation, TypeWithAnnotations underlying)
            {
            ...
            internal abstract TypeWithAnnotations WithModifiers(TypeWithAnnotations type,
                ImmutableArray<CustomModifier> customModifiers);
            ...
            internal abstract TypeWithAnnotations WithTypeAndModifiers(TypeWithAnnotations type, TypeSymbol typeSymbol,
                ImmutableArray<CustomModifier> customModifiers);

            internal abstract bool TypeSymbolEquals(TypeWithAnnotations type, TypeWithAnnotations other,
            ...
            internal abstract void ReportDiagnosticsIfObsolete(TypeWithAnnotations type, Binder binder,
        ...
        private sealed class NonLazyType : Extensions
        {
            ...
            internal override TypeSymbol GetNullableUnderlyingTypeOrSelf(TypeSymbol typeSymbol) =>
                typeSymbol.StrippedType();

            internal override TypeWithAnnotations WithModifiers(TypeWithAnnotations type,
                ImmutableArray<CustomModifier> customModifiers)
            {
            ...
            internal override TypeWithAnnotations WithTypeAndModifiers(TypeWithAnnotations type, TypeSymbol typeSymbol,
                ImmutableArray<CustomModifier> customModifiers)
            {
            ...
            internal override TypeWithAnnotations AsNotNullableReferenceType(TypeWithAnnotations type)
            {
                ...
                return CreateNonLazyType(defaultType,
                    defaultType.IsNullableType() ? type.NullableAnnotation : NullableAnnotation.NotAnnotated,
                    _customModifiers);
            }

            internal override bool TypeSymbolEquals(TypeWithAnnotations type, TypeWithAnnotations other,
                TypeCompareKind comparison)
            {
            ...
            internal override void ReportDiagnosticsIfObsolete(TypeWithAnnotations type, Binder binder,
                SyntaxNode syntax, BindingDiagnosticBag diagnostics)
            {
        ...
        private sealed class LazyNullableTypeParameter : Extensions
        {
            ...
            public LazyNullableTypeParameter(AquilaCompilation compilation, TypeWithAnnotations underlying)
            {
            ...
            internal override bool IsRestrictedType(TypeSymbol typeSymbol, bool ignoreSpanLikeTypes) =>
                _underlying.IsRestrictedType(ignoreSpanLikeTypes);
                ...
                ImmutableArray<CustomModifier> customModifiers)
            {
                ...
                {
                    return TypeWithAnnotations.Create(resolvedType, type.NullableAnnotation,
                ...
                ImmutableArray<CustomModifier> customModifiers)
            {
                ...
                {
                    return TypeWithAnnotations.Create(typeSymbol, type.NullableAnnotation,
                        customModifiers: customModifiers);
                }

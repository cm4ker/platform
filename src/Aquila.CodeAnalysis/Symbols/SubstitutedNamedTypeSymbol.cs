...
namespace Aquila.CodeAnalysis.Symbols
{
    ...
    internal abstract class SubstitutedNamedTypeSymbol : NamedTypeSymbol
    {
        ...
        protected SubstitutedNamedTypeSymbol(Symbol newContainer, TypeMap map, NamedTypeSymbol originalDefinition,
            NamedTypeSymbol constructedFrom = null, bool unbound = false)
        {
        ...
        private void EnsureMapAndTypeParameters()
        {
            ...
            ImmutableInterlocked.InterlockedCompareExchange(ref _lazyTypeParameters, typeParameters,
        ...
        public sealed override IEnumerable<string> MemberNames
        {
            ...
            {
                return _unbound
                    ? new List<string>(GetTypeMembers() /*GetTypeMembersUnordered()*/.Select(s => s.Name).Distinct())
                    : _originalDefinition.MemberNames;
            }
        }

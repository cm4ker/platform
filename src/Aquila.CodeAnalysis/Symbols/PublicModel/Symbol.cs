 ...
 namespace Aquila.CodeAnalysis.Symbols.PublicModel
{
    internal abstract class Symbol : ISymbol
    {
        ...
        {
            return this.Equals(other as Symbol, Microsoft.CodeAnalysis.SymbolEqualityComparer.Default);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToDisplayString(this, format);
        }

        ImmutableArray<SymbolDisplayPart> ISymbol.ToDisplayParts(SymbolDisplayFormat format)
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToDisplayParts(this, format);
        }

        string ISymbol.ToMinimalDisplayString(SemanticModel semanticModel, int position, SymbolDisplayFormat format)
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayString(this, GetCSharpSemanticModel(semanticModel), position, format);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayParts(this, GetCSharpSemanticModel(semanticModel), position, format);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToDisplayString(this);
        }
    }
}

 ...
 namespace Aquila.CodeAnalysis.Symbols.PublicModel
{
    internal abstract class NamedTypeSymbol : TypeSymbol, INamedTypeSymbol
    {
        ...
        INamedTypeSymbol INamedTypeSymbol.TupleUnderlyingType
        {
            get
            {
                ...
                return type.Equals(tupleUnderlyingType, TypeCompareKind.ConsiderEverything) ?
                    null :
                    SymbolExtensions.GetPublicSymbol((Symbols.NamedTypeSymbol?) tupleUnderlyingType);
            }
        }
        ...
        INamedTypeSymbol INamedTypeSymbol.NativeIntegerUnderlyingType => SymbolExtensions.GetPublicSymbol((Symbols.NamedTypeSymbol?) UnderlyingNamedTypeSymbol.NativeIntegerUnderlyingType);

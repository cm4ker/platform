 ...
 namespace Aquila.CodeAnalysis.Symbols.PublicModel
{
    internal sealed class PreprocessingSymbol : IPreprocessingSymbol
    {
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayString(this, Symbol.GetCSharpSemanticModel(semanticModel), position, format);
        }
        ...
        {
            return Microsoft.CodeAnalysis.SymbolDisplay.ToMinimalDisplayParts(this, Symbol.GetCSharpSemanticModel(semanticModel), position, format);
        }

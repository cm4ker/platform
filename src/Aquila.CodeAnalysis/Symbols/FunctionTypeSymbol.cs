...
namespace Aquila.CodeAnalysis.Symbols
{
    ...
    {
        internal static readonly FunctionTypeSymbol Uninitialized =
            new FunctionTypeSymbol(ErrorTypeSymbol.UnknownResultType);
        ...
        {
            return (object)_delegateType == delegateType ? this : new FunctionTypeSymbol(delegateType);
        }

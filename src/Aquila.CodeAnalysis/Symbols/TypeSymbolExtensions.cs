...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
        ...
        internal static Microsoft.Cci.TypeReferenceWithAttributes GetTypeRefWithAttributes(
            this TypeWithAnnotations type,
            Microsoft.CodeAnalysis.Emit.PEModuleBuilder moduleBuilder,
            Symbol declaringSymbol,
            Microsoft.Cci.ITypeReference typeRef)
        {
            var builder = ArrayBuilder<Microsoft.Cci.ICustomAttribute>.GetInstance();
            ...
            if (compilation != null)
            {
                ...
                static void addIfNotNull(ArrayBuilder<Microsoft.Cci.ICustomAttribute> builder, SynthesizedAttributeData? attr)
                {
                    if (attr != null)
                    {
                        builder.Add(attr);
            ...
            return new Microsoft.Cci.TypeReferenceWithAttributes(typeRef, builder.ToImmutableAndFree());
        }

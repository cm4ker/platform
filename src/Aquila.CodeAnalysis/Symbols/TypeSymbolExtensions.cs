...
namespace Aquila.CodeAnalysis.Symbols
{
    internal static partial class TypeSymbolExtensions
    {
        ...
        /// </summary>
        public static bool IsPhpSourceFile(this ITypeSymbol type) =>
            type is IPhpScriptTypeSymbol phpt && phpt.MainMethod != null;

        public static bool IsPharEntry(this ITypeSymbol type) => type is NamedTypeSymbol ntype &&
                                                                 ntype.NamespaceName.StartsWith(WellKnownPchpNames
                                                                     .PharEntryRootNamespace);
        ...
        public static bool IsPhpUserType(this TypeSymbol /*!*/type) =>
            ...
            (type.TryGetPhpTypeAttribute(out _, out var fname, out _) &&
             fname != null); // or referenced with [PhpType("name", "path to original PHP file")]
        ...
        public static bool ImplementsInterface(this TypeSymbol subType,
            TypeSymbol superInterface /*, ref HashSet<DiagnosticInfo> useSiteDiagnostics*/)
        {
        ...
        {
            return t.MetadataName == "PhpArray" &&
                   (t.ContainingAssembly as AssemblySymbol)?.IsPeachpieCorLibrary == true;
        }

        public static bool Is_PhpResource(this ITypeSymbolInternal t)
        {
            return t.MetadataName == "PhpResource" &&
                   (t.ContainingAssembly as AssemblySymbol)?.IsPeachpieCorLibrary == true;
        }

        public static bool Is_PhpAlias(this ITypeSymbolInternal t)
        {
            return t.MetadataName == "PhpAlias" &&
                   (t.ContainingAssembly as AssemblySymbol)?.IsPeachpieCorLibrary == true;
        }

        public static bool Is_PhpValue(this ITypeSymbolInternal t)
        {
            return t.MetadataName == "PhpValue" &&
                   (t.ContainingAssembly as AssemblySymbol)?.IsPeachpieCorLibrary == true;
        }

        public static bool Is_PhpString(this ITypeSymbolInternal t)
        {
            return t.MetadataName == "PhpString" &&
                   (t.ContainingAssembly as AssemblySymbol)?.IsPeachpieCorLibrary == true;
        }

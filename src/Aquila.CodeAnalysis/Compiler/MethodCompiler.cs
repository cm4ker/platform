...
namespace Aquila.CodeAnalysis
{
    internal sealed class MethodCompiler : AquilaSymbolVisitor<TypeCompilationState, object>
    {
            ...
            BindingDiagnosticBag diagnostics)
        {
            ...
            foreach (IMethodDefinition definition in privateImplClass.GetMethods(
        ...
        /// </summary>
        private void CompileSynthesizedExplicitImplementations(SourceModuleTypeSymbol sourceTypeSymbol,

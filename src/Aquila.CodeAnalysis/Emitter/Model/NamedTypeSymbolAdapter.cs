...
namespace Aquila.CodeAnalysis.Symbols
{
        ...
        Cci.ISpecializedNestedTypeReference
    {
            ...
            EmitContext context)
        {
            ...
            foreach (var method in this.GetMembers().OfType<MethodSymbol>()
        ...
        /// </remarks>
        private static void InterfacesVisit(NamedTypeSymbol namedType,
            ArrayBuilder<NamedTypeSymbol> builder, ref HashSet<NamedTypeSymbol> seen)
        {
            ...
            foreach (NamedTypeSymbol @interface in namedType.Interfaces

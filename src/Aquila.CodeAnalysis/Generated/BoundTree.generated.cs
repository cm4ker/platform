...
namespace Aquila.CodeAnalysis
{
    ...
    {
        public BoundTypeExpression(SyntaxNode syntax, BoundTypeExpression? boundContainingTypeOpt, ImmutableArray<BoundExpression> boundDimensionsOpt, TypeWithAnnotations typeWithAnnotations, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundTypeExpression Update(BoundTypeExpression? boundContainingTypeOpt, ImmutableArray<BoundExpression> boundDimensionsOpt, TypeWithAnnotations typeWithAnnotations, TypeSymbol type)
        {
            if (boundContainingTypeOpt != this.BoundContainingTypeOpt || boundDimensionsOpt != this.BoundDimensionsOpt || typeWithAnnotations != this.TypeWithAnnotations || !TypeSymbol.Equals(type, this.Type, TypeCompareKind.ConsiderEverything))
            {
                var result = new BoundTypeExpression(this.Syntax, boundContainingTypeOpt, boundDimensionsOpt, typeWithAnnotations, type, this.HasErrors);
                result.CopyAttributes(this);
                return result;
            }
            return this;
    ...
    {
        public BoundNamespaceExpression(SyntaxNode syntax, NamespaceSymbol namespaceSymbol, bool hasErrors)
        ...
        {
            if (!Symbols.SymbolEqualityComparer.ConsiderEverything.Equals(namespaceSymbol, this.NamespaceSymbol))
            {
                var result = new BoundNamespaceExpression(this.Syntax, namespaceSymbol, this.HasErrors);
                result.CopyAttributes(this);
                return result;
            }
            return this;
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode? VisitTypeExpression(BoundTypeExpression node)
        {
            ...
            TypeSymbol? type = this.VisitType(node.Type);
            return node.Update(boundContainingTypeOpt, boundDimensionsOpt, node.TypeWithAnnotations, type);
        }
        ...
        {
            TypeSymbol? type = this.VisitType(node.Type);
            return node.Update(node.NamespaceSymbol);
        }
        public override BoundNode? VisitUnaryOperator(BoundUnaryOperator node)
        {

...
namespace Aquila.CodeAnalysis.Syntax
{
    ...
    /// <list type="bullet">
    /// <item><description><see cref="SyntaxKind.ModuleDecl"/></description></item>
    /// </list>
    /// </remarks>
    public sealed partial class ModuleDecl : AquilaSyntaxNode
    {
        private NameEx? name;

        internal ModuleDecl(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }

        public SyntaxToken ModuleKeyword => new SyntaxToken(this, ((Syntax.InternalSyntax.ModuleDecl)this.Green).moduleKeyword, Position, 0);

        public NameEx Name => GetRed(ref this.name, 1)!;

        /// <summary>SyntaxToken representing the semicolon token.</summary>
        public SyntaxToken SemicolonToken => new SyntaxToken(this, ((Syntax.InternalSyntax.ModuleDecl)this.Green).semicolonToken, GetChildPosition(2), GetChildIndex(2));
        ...
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitModuleDecl(this);
        ...
        public ModuleDecl WithModuleKeyword(SyntaxToken moduleKeyword) => Update(moduleKeyword, this.Name, this.SemicolonToken);
        public ModuleDecl WithName(NameEx name) => Update(this.ModuleKeyword, name, this.SemicolonToken);
        public ModuleDecl WithSemicolonToken(SyntaxToken semicolonToken) => Update(this.ModuleKeyword, this.Name, semicolonToken);
    }

    /// <remarks>
    /// <para>This node is associated with the following syntax kinds:</para>
    /// <list type="bullet">
    /// <item><description><see cref="SyntaxKind.HtmlDecl"/></description></item>
    /// </list>
    /// </remarks>
    public sealed partial class HtmlDecl : AquilaSyntaxNode
    {
        private HtmlMarkupDecl? htmlMarkup;
        private HtmlCodeSyntax? htmlCode;

        internal HtmlDecl(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }

        public HtmlMarkupDecl? HtmlMarkup => GetRedAtZero(ref this.htmlMarkup);

        public HtmlCodeSyntax? HtmlCode => GetRed(ref this.htmlCode, 1);

        internal override SyntaxNode? GetNodeSlot(int index)
            => index switch
            {
                0 => GetRedAtZero(ref this.htmlMarkup),
                1 => GetRed(ref this.htmlCode, 1),
                _ => null,
            };
        ...
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitHtmlDecl(this);
        ...
        public HtmlDecl WithHtmlMarkup(HtmlMarkupDecl? htmlMarkup) => Update(htmlMarkup, this.HtmlCode);
        public HtmlDecl WithHtmlCode(HtmlCodeSyntax? htmlCode) => Update(this.HtmlMarkup, htmlCode);

        public HtmlDecl AddHtmlMarkupHtmlNodes(params HtmlNodeSyntax[] items)
        {
            var htmlMarkup = this.HtmlMarkup ?? SyntaxFactory.HtmlMarkupDecl();
            return WithHtmlMarkup(htmlMarkup.WithHtmlNodes(htmlMarkup.HtmlNodes.AddRange(items)));
        }
    }
    ...
    public sealed partial class CompilationUnitSyntax : AquilaSyntaxNode
    {
        ...
        public ModuleDecl? Module => GetRedAtZero(ref this.module);

        public SyntaxList<ImportDecl> Imports => new SyntaxList<ImportDecl>(GetRed(ref this.imports, 1));

        public HtmlDecl? Html => GetRed(ref this.html, 2);
        ...
        public CompilationUnitSyntax Update(ModuleDecl? module, SyntaxList<ImportDecl> imports, HtmlDecl? html, SyntaxList<MemberDecl> members, SyntaxToken endOfFileToken)
        {
            if (module != this.Module || imports != this.Imports || html != this.Html || members != this.Members || endOfFileToken != this.EndOfFileToken)
            {
                var newNode = SyntaxFactory.CompilationUnit(module, imports, html, members, endOfFileToken);
                var annotations = GetAnnotations();
                return annotations?.Length > 0 ? newNode.WithAnnotations(annotations) : newNode;
            }
        ...
        public CompilationUnitSyntax WithModule(ModuleDecl? module) => Update(module, this.Imports, this.Html, this.Members, this.EndOfFileToken);
        public CompilationUnitSyntax WithImports(SyntaxList<ImportDecl> imports) => Update(this.Module, imports, this.Html, this.Members, this.EndOfFileToken);
        public CompilationUnitSyntax WithHtml(HtmlDecl? html) => Update(this.Module, this.Imports, html, this.Members, this.EndOfFileToken);
        public CompilationUnitSyntax WithMembers(SyntaxList<MemberDecl> members) => Update(this.Module, this.Imports, this.Html, members, this.EndOfFileToken);
        public CompilationUnitSyntax WithEndOfFileToken(SyntaxToken endOfFileToken) => Update(this.Module, this.Imports, this.Html, this.Members, endOfFileToken);
    ...
    public sealed partial class ImportDecl : AquilaSyntaxNode
    {
        ...
        public SyntaxToken ClrKeyword
        {
            get
            {
                var slot = ((Syntax.InternalSyntax.ImportDecl)this.Green).clrKeyword;
        ...
        /// <summary>SyntaxToken representing the semicolon token.</summary>
        public SyntaxToken SemicolonToken => new SyntaxToken(this, ((Syntax.InternalSyntax.ImportDecl)this.Green).semicolonToken, GetChildPosition(3), GetChildIndex(3));
        ...
        public ImportDecl WithImportKeyword(SyntaxToken importKeyword) => Update(importKeyword, this.ClrKeyword, this.Name, this.SemicolonToken);
        public ImportDecl WithClrKeyword(SyntaxToken clrKeyword) => Update(this.ImportKeyword, clrKeyword, this.Name, this.SemicolonToken);
        public ImportDecl WithName(NameEx name) => Update(this.ImportKeyword, this.ClrKeyword, name, this.SemicolonToken);
        public ImportDecl WithSemicolonToken(SyntaxToken semicolonToken) => Update(this.ImportKeyword, this.ClrKeyword, this.Name, semicolonToken);
    }
    ...
    /// </list>
    /// </remarks>
    public sealed partial class TypeDecl : MemberDecl
    {
        ...
        public SyntaxToken TypeKeyword => new SyntaxToken(this, ((Syntax.InternalSyntax.TypeDecl)this.Green).typeKeyword, GetChildPosition(2), GetChildIndex(2));

        public NameEx Name => GetRed(ref this.name, 3)!;

        /// <summary>SyntaxToken representing the open brace.</summary>
        public SyntaxToken OpenBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.TypeDecl)this.Green).openBraceToken, GetChildPosition(4), GetChildIndex(4));

        public SyntaxList<FieldDecl> Fields => new SyntaxList<FieldDecl>(GetRed(ref this.fields, 5));

        /// <summary>SyntaxToken representing the close brace.</summary>
        public SyntaxToken CloseBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.TypeDecl)this.Green).closeBraceToken, GetChildPosition(6), GetChildIndex(6));
        ...
        public TypeDecl Update(SyntaxList<AttributeListSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken typeKeyword, NameEx name, SyntaxToken openBraceToken, SyntaxList<FieldDecl> fields, SyntaxToken closeBraceToken)
        {
        ...
        public new TypeDecl WithAttributeLists(SyntaxList<AttributeListSyntax> attributeLists) => Update(attributeLists, this.Modifiers, this.TypeKeyword, this.Name, this.OpenBraceToken, this.Fields, this.CloseBraceToken);
        internal override MemberDecl WithModifiersCore(SyntaxTokenList modifiers) => WithModifiers(modifiers);
        public new TypeDecl WithModifiers(SyntaxTokenList modifiers) => Update(this.AttributeLists, modifiers, this.TypeKeyword, this.Name, this.OpenBraceToken, this.Fields, this.CloseBraceToken);
        public TypeDecl WithTypeKeyword(SyntaxToken typeKeyword) => Update(this.AttributeLists, this.Modifiers, typeKeyword, this.Name, this.OpenBraceToken, this.Fields, this.CloseBraceToken);
        public TypeDecl WithName(NameEx name) => Update(this.AttributeLists, this.Modifiers, this.TypeKeyword, name, this.OpenBraceToken, this.Fields, this.CloseBraceToken);
        public TypeDecl WithOpenBraceToken(SyntaxToken openBraceToken) => Update(this.AttributeLists, this.Modifiers, this.TypeKeyword, this.Name, openBraceToken, this.Fields, this.CloseBraceToken);
        public TypeDecl WithFields(SyntaxList<FieldDecl> fields) => Update(this.AttributeLists, this.Modifiers, this.TypeKeyword, this.Name, this.OpenBraceToken, fields, this.CloseBraceToken);
        public TypeDecl WithCloseBraceToken(SyntaxToken closeBraceToken) => Update(this.AttributeLists, this.Modifiers, this.TypeKeyword, this.Name, this.OpenBraceToken, this.Fields, closeBraceToken);

        internal override MemberDecl AddAttributeListsCore(params AttributeListSyntax[] items) => AddAttributeLists(items);
        public new TypeDecl AddAttributeLists(params AttributeListSyntax[] items) => WithAttributeLists(this.AttributeLists.AddRange(items));
        internal override MemberDecl AddModifiersCore(params SyntaxToken[] items) => AddModifiers(items);
        public new TypeDecl AddModifiers(params SyntaxToken[] items) => WithModifiers(this.Modifiers.AddRange(items));
    ...
    /// <para>This node is associated with the following syntax kinds:</para>
    /// <list type="bullet">
    /// <item><description><see cref="SyntaxKind.FuncOwner"/></description></item>
    /// </list>
    /// </remarks>
    public sealed partial class FuncOwnerSyntax : AquilaSyntaxNode
    {
        private TypeEx? ownerType;

        internal FuncOwnerSyntax(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }

        /// <summary>Gets the open paren token.</summary>
        public SyntaxToken OpenParenToken => new SyntaxToken(this, ((Syntax.InternalSyntax.FuncOwnerSyntax)this.Green).openParenToken, Position, 0);

        /// <summary>Gets the identifier.</summary>
        public SyntaxToken Identifier => new SyntaxToken(this, ((Syntax.InternalSyntax.FuncOwnerSyntax)this.Green).identifier, GetChildPosition(1), GetChildIndex(1));

        public TypeEx OwnerType => GetRed(ref this.ownerType, 2)!;
        ...
        public SyntaxToken CloseParenToken
        {
            get
            {
                var slot = ((Syntax.InternalSyntax.FuncOwnerSyntax)this.Green).closeParenToken;
                return slot != null ? new SyntaxToken(this, slot, GetChildPosition(3), GetChildIndex(3)) : default;
            }
        }

        internal override SyntaxNode? GetNodeSlot(int index) => index == 2 ? GetRed(ref this.ownerType, 2)! : null;

        internal override SyntaxNode? GetCachedSlot(int index) => index == 2 ? this.ownerType : null;

        public override void Accept(AquilaSyntaxVisitor visitor) => visitor.VisitFuncOwner(this);
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitFuncOwner(this);
        ...
        public FuncOwnerSyntax WithOpenParenToken(SyntaxToken openParenToken) => Update(openParenToken, this.Identifier, this.OwnerType, this.CloseParenToken);
        public FuncOwnerSyntax WithIdentifier(SyntaxToken identifier) => Update(this.OpenParenToken, identifier, this.OwnerType, this.CloseParenToken);
        public FuncOwnerSyntax WithOwnerType(TypeEx ownerType) => Update(this.OpenParenToken, this.Identifier, ownerType, this.CloseParenToken);
        public FuncOwnerSyntax WithCloseParenToken(SyntaxToken closeParenToken) => Update(this.OpenParenToken, this.Identifier, this.OwnerType, closeParenToken);
    }
    ...
    /// <para>This node is associated with the following syntax kinds:</para>
    /// <list type="bullet">
    /// <item><description><see cref="SyntaxKind.FuncDecl"/></description></item>
    /// </list>
    /// </remarks>
    public sealed partial class FuncDecl : MemberDecl
    {
        private SyntaxNode? attributeLists;
        private FuncOwnerSyntax? funcOwner;
        private TypeParameterListSyntax? typeParameterList;
        private ParameterListSyntax? parameterList;
        private TypeEx? returnType;
        private BlockStmt? body;
        ...
        internal FuncDecl(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }
        ...
        public SyntaxToken FnKeyword => new SyntaxToken(this, ((Syntax.InternalSyntax.FuncDecl)this.Green).fnKeyword, GetChildPosition(2), GetChildIndex(2));

        public FuncOwnerSyntax? FuncOwner => GetRed(ref this.funcOwner, 3);

        /// <summary>Gets the identifier.</summary>
        public SyntaxToken Identifier => new SyntaxToken(this, ((Syntax.InternalSyntax.FuncDecl)this.Green).identifier, GetChildPosition(4), GetChildIndex(4));
        ...
        /// <summary>Gets the return type syntax.</summary>
        public TypeEx? ReturnType => GetRed(ref this.returnType, 7);

        public BlockStmt? Body => GetRed(ref this.body, 8);

        public ArrowExClause? ExpressionBody => GetRed(ref this.expressionBody, 9);
        ...
        public SyntaxToken SemicolonToken
        {
            get
            {
                var slot = ((Syntax.InternalSyntax.FuncDecl)this.Green).semicolonToken;
        ...
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitFuncDecl(this);

        public FuncDecl Update(SyntaxList<AttributeListSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken fnKeyword, FuncOwnerSyntax? funcOwner, SyntaxToken identifier, TypeParameterListSyntax? typeParameterList, ParameterListSyntax parameterList, TypeEx? returnType, BlockStmt? body, ArrowExClause? expressionBody, SyntaxToken semicolonToken)
        {
        ...
        internal override MemberDecl WithAttributeListsCore(SyntaxList<AttributeListSyntax> attributeLists) => WithAttributeLists(attributeLists);
        public new FuncDecl WithAttributeLists(SyntaxList<AttributeListSyntax> attributeLists) => Update(attributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        internal override MemberDecl WithModifiersCore(SyntaxTokenList modifiers) => WithModifiers(modifiers);
        public new FuncDecl WithModifiers(SyntaxTokenList modifiers) => Update(this.AttributeLists, modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithFnKeyword(SyntaxToken fnKeyword) => Update(this.AttributeLists, this.Modifiers, fnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithFuncOwner(FuncOwnerSyntax? funcOwner) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, funcOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithIdentifier(SyntaxToken identifier) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithTypeParameterList(TypeParameterListSyntax? typeParameterList) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, typeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithParameterList(ParameterListSyntax parameterList) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, parameterList, this.ReturnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithReturnType(TypeEx? returnType) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, returnType, this.Body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithBody(BlockStmt? body) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, body, this.ExpressionBody, this.SemicolonToken);
        public FuncDecl WithExpressionBody(ArrowExClause? expressionBody) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, expressionBody, this.SemicolonToken);
        public FuncDecl WithSemicolonToken(SyntaxToken semicolonToken) => Update(this.AttributeLists, this.Modifiers, this.FnKeyword, this.FuncOwner, this.Identifier, this.TypeParameterList, this.ParameterList, this.ReturnType, this.Body, this.ExpressionBody, semicolonToken);

        internal override MemberDecl AddAttributeListsCore(params AttributeListSyntax[] items) => AddAttributeLists(items);
        public new FuncDecl AddAttributeLists(params AttributeListSyntax[] items) => WithAttributeLists(this.AttributeLists.AddRange(items));
        internal override MemberDecl AddModifiersCore(params SyntaxToken[] items) => AddModifiers(items);
        public new FuncDecl AddModifiers(params SyntaxToken[] items) => WithModifiers(this.Modifiers.AddRange(items));
        public FuncDecl AddTypeParameterListParameters(params TypeParameterSyntax[] items)
        {
            var typeParameterList = this.TypeParameterList ?? SyntaxFactory.TypeParameterList();
            return WithTypeParameterList(typeParameterList.WithParameters(typeParameterList.Parameters.AddRange(items)));
        }
        public FuncDecl AddParameterListParameters(params ParameterSyntax[] items) => WithParameterList(this.ParameterList.WithParameters(this.ParameterList.Parameters.AddRange(items)));
        public FuncDecl AddBodyStatements(params StmtSyntax[] items)
        {
            var body = this.Body ?? SyntaxFactory.BlockStmt();
            return WithBody(body.WithStatements(body.Statements.AddRange(items)));
        }
    ...
    /// </list>
    /// </remarks>
    public sealed partial class CastEx : ExprSyntax
    {
        private TypeEx? type;
        private ExprSyntax? expression;

        internal CastEx(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }

        /// <summary>SyntaxToken representing the open parenthesis.</summary>
        public SyntaxToken OpenParenToken => new SyntaxToken(this, ((Syntax.InternalSyntax.CastEx)this.Green).openParenToken, Position, 0);
        ...
        /// <summary>SyntaxToken representing the close parenthesis.</summary>
        public SyntaxToken CloseParenToken => new SyntaxToken(this, ((Syntax.InternalSyntax.CastEx)this.Green).closeParenToken, GetChildPosition(2), GetChildIndex(2));

        /// <summary>ExpressionSyntax node representing the expression that is being casted.</summary>
        public ExprSyntax Expression => GetRed(ref this.expression, 3)!;
        ...
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitCastEx(this);
        ...
        public CastEx WithOpenParenToken(SyntaxToken openParenToken) => Update(openParenToken, this.Type, this.CloseParenToken, this.Expression);
        public CastEx WithType(TypeEx type) => Update(this.OpenParenToken, type, this.CloseParenToken, this.Expression);
        public CastEx WithCloseParenToken(SyntaxToken closeParenToken) => Update(this.OpenParenToken, this.Type, closeParenToken, this.Expression);
    ...
    public sealed partial class ParameterSyntax : BaseParameterSyntax
    {
        ...
        public override TypeEx? Type => GetRed(ref this.type, 3);
        ...
        public ParameterSyntax Update(SyntaxList<AttributeListSyntax> attributeLists, SyntaxTokenList modifiers, SyntaxToken identifier, TypeEx? type, EqualsValueClauseSyntax? @default)
        {
        ...
        public new ParameterSyntax WithAttributeLists(SyntaxList<AttributeListSyntax> attributeLists) => Update(attributeLists, this.Modifiers, this.Identifier, this.Type, this.Default);
        internal override BaseParameterSyntax WithModifiersCore(SyntaxTokenList modifiers) => WithModifiers(modifiers);
        public new ParameterSyntax WithModifiers(SyntaxTokenList modifiers) => Update(this.AttributeLists, modifiers, this.Identifier, this.Type, this.Default);
        ...
        public new ParameterSyntax WithType(TypeEx? type) => Update(this.AttributeLists, this.Modifiers, this.Identifier, type, this.Default);
    ...
    /// <para>This node is associated with the following syntax kinds:</para>
    /// <list type="bullet">
    /// <item><description><see cref="SyntaxKind.HtmlMarkupDecl"/></description></item>
    /// </list>
    /// </remarks>
    public sealed partial class HtmlMarkupDecl : AquilaSyntaxNode
    {
        private SyntaxNode? htmlNodes;

        internal HtmlMarkupDecl(InternalSyntax.AquilaSyntaxNode green, SyntaxNode? parent, int position)
          : base(green, parent, position)
        {
        }

        public SyntaxList<HtmlNodeSyntax> HtmlNodes => new SyntaxList<HtmlNodeSyntax>(GetRed(ref this.htmlNodes, 0));

        internal override SyntaxNode? GetNodeSlot(int index) => index == 0 ? GetRedAtZero(ref this.htmlNodes)! : null;

        internal override SyntaxNode? GetCachedSlot(int index) => index == 0 ? this.htmlNodes : null;

        public override void Accept(AquilaSyntaxVisitor visitor) => visitor.VisitHtmlMarkupDecl(this);
        public override TResult? Accept<TResult>(AquilaSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitHtmlMarkupDecl(this);

        public HtmlMarkupDecl Update(SyntaxList<HtmlNodeSyntax> htmlNodes)
        {
        ...
        public HtmlMarkupDecl WithHtmlNodes(SyntaxList<HtmlNodeSyntax> htmlNodes) => Update(htmlNodes);

        public HtmlMarkupDecl AddHtmlNodes(params HtmlNodeSyntax[] items) => WithHtmlNodes(this.HtmlNodes.AddRange(items));
    }

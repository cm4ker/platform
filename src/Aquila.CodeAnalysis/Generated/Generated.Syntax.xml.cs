...
namespace Aquila.Syntax.Ast
{
    public record ModifierList : LangCollection<ModifierToken>
    {
        public static ModifierList Empty => new ModifierList(ImmutableArray<ModifierToken>.Empty);
        public ModifierList(ImmutableArray<ModifierToken> elements): base(Span.Empty, elements)
        {
        }
...
namespace Aquila.Syntax.Ast
{
    public record ImportList : LangCollection<ImportBase>
    {
        public static ImportList Empty => new ImportList(ImmutableArray<ImportBase>.Empty);
        public ImportList(ImmutableArray<ImportBase> elements): base(Span.Empty, elements)
        {
        }
...
namespace Aquila.Syntax.Ast
{
    public partial record SourceUnit : LangElement
    {
        ...
        public ImportList Imports { get => this.imports; init => this.imports = value; }
...
namespace Aquila.Syntax.Ast
{
    public abstract partial record ImportBase : LangElement
    {
        public ImportBase(Span span, SyntaxKind syntaxKind, String name): base(span, syntaxKind)
        {
            Name = name;
        }
...
namespace Aquila.Syntax.Ast
{
    public partial record ImportDecl : ImportBase
    {
        public ImportDecl(Span span, SyntaxKind syntaxKind, String name): base(span, syntaxKind, name)
        {
            Name = name;
        }
...
namespace Aquila.Syntax.Ast
{
    public partial record ImportAliasDecl : ImportBase
    {
        public ImportAliasDecl(Span span, SyntaxKind syntaxKind, String className, String alias): base(span, syntaxKind, className)
        {
            ClassName = className;
            Alias = alias;
        }
        ...
        public override T Accept<T>(AstVisitorBase<T> visitor)
        {
            return visitor.VisitImportAliasDecl(this);
        }

        public override void Accept(AstVisitorBase visitor)
        {
            visitor.VisitImportAliasDecl(this);
        }
...
namespace Aquila.Syntax.Ast
{
    public partial record ModifierToken : SyntaxToken
    {
        public ModifierToken(Span span, SyntaxKind syntaxKind, String text): base(span, syntaxKind, text)
        {
        }

        public override T Accept<T>(AstVisitorBase<T> visitor)
        {
            return visitor.VisitModifierToken(this);
        }

        public override void Accept(AstVisitorBase visitor)
        {
            visitor.VisitModifierToken(this);
        }
...
namespace Aquila.Syntax.Ast.Functions
{
    ...
    {
        public MethodDecl(Span span, SyntaxKind syntaxKind, BlockStmt block, ParameterList parameters, AnnotationList annotations, IdentifierToken identifier, TypeRef returnType, ModifierList modifiers,  bool  isGlobal = false): base(span, syntaxKind)
        {
            this.block = block;
        ...
        public ModifierList Modifiers { get => this.modifiers; init => this.modifiers = value; }

        public bool IsGlobal { get => this.isGlobal; init => this.isGlobal = value; }
...
namespace Aquila.Syntax.Ast.Statements
{
    ...
    {
        public ForStmt(Span span, SyntaxKind syntaxKind, BlockStmt block, Expression counter, Expression condition, VarDecl varDecl): base(span, syntaxKind)
        {
            this.block = block;
        ...
        public VarDecl VarDecl { get => this.varDecl; init => this.varDecl = value; }
...
namespace Aquila.Syntax
{
    public abstract partial class AstVisitorBase<T>
    {
        ...
        public virtual T VisitModifierList(ModifierList arg)
        {
            return DefaultVisit(arg);
        }
        ...
        public virtual T VisitImportList(ImportList arg)
        {
            return DefaultVisit(arg);
        }
        ...
        public virtual T VisitImportDecl(ImportDecl arg)
        {
            return DefaultVisit(arg);
        }

        public virtual T VisitImportAliasDecl(ImportAliasDecl arg)
        {
            return DefaultVisit(arg);
        }
        ...
        public virtual T VisitModifierToken(ModifierToken arg)
        {
            return DefaultVisit(arg);
        }
    ...
    public abstract partial class AstVisitorBase
    {
        ...
        public virtual void VisitImportList(ImportList arg)
        {
            DefaultVisit(arg);
        }
        ...
        public virtual void VisitImportDecl(ImportDecl arg)
        {
            DefaultVisit(arg);
        }

        public virtual void VisitImportAliasDecl(ImportAliasDecl arg)
        {
            DefaultVisit(arg);
        }
        ...
        public virtual void VisitModifierToken(ModifierToken arg)
        {
            DefaultVisit(arg);
        }

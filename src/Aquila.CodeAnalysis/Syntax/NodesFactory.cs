...
//         /// </summary>
//         public List<MethodDecl> Functions => _functions;
//
//         List<MethodDecl> _functions;
//
//         /// <summary>
...
//
//         List<(int, object)>
//             _annotations; // list of parsed custom attributes, will be taken and used for the next declaration
//
//         /// <summary>
...
//         {
//             Debug.Assert(_annotations == null || _annotations.Count == 0,
//                 $"file {this.SourceUnit.FilePath} contains CLR annotations we did not consume! Probably a bogus in AdditionalSyntaxProvider."); // all parsed custom annotations have to be consumed
//
//             return Root = (GlobalCode) base.GlobalCode(span, statements, context);
//         }
//
//         public override LangElement Function(Span span, bool conditional, bool aliasReturn,
//             PhpMemberAttributes attributes, TypeRef returnType, Name name, Span nameSpan,
//             IEnumerable<FormalTypeParam> typeParamsOpt, IEnumerable<FormalParam> formalParams, Span formalParamsSpan,
//             LangElement body)
//         {
//             return AddAndReturn(ref _functions,
//                 WithCustomAttributes((FunctionDecl) base.Function(span, conditional, aliasReturn, attributes,
//                     returnType, name, nameSpan, typeParamsOpt, formalParams, formalParamsSpan, body)));
//         }
//
//         public override LangElement Type(Span span, Span headingSpan, bool conditional, PhpMemberAttributes attributes,
//             Name name, Span nameSpan, IEnumerable<FormalTypeParam> typeParamsOpt, INamedTypeRef baseClassOpt,
//             IEnumerable<INamedTypeRef> implements, IEnumerable<LangElement> members, Span bodySpan)
//         {
//             var tref = (TypeDecl) base.Type(span, headingSpan, conditional, attributes, name, nameSpan, typeParamsOpt,
//                 baseClassOpt, implements, members, bodySpan);
//
//             return AddAndReturn(ref _types, WithCustomAttributes(tref));
//         }
//
//         public override LangElement DeclList(Span span, PhpMemberAttributes attributes, IList<LangElement> decls,
//             TypeRef type)
//         {
//             return WithCustomAttributes(base.DeclList(span, attributes, decls, type));
//         }
//
//         public override LangElement Method(Span span, bool aliasReturn, PhpMemberAttributes attributes,
//             TypeRef returnType, Span returnTypeSpan, string name, Span nameSpan,
//             IEnumerable<FormalTypeParam> typeParamsOpt, IEnumerable<FormalParam> formalParams, Span formalParamsSpan,
//             IEnumerable<ActualParam> baseCtorParams, LangElement body)
//         {
//             return WithCustomAttributes(
//                 base.Method(span, aliasReturn, attributes, returnType, returnTypeSpan, name, nameSpan, typeParamsOpt,
//                     formalParams, formalParamsSpan, baseCtorParams, body));
//         }
//
//         public override TypeRef AnonymousTypeReference(Span span, Span headingSpan, bool conditional,
//             PhpMemberAttributes attributes, IEnumerable<FormalTypeParam> typeParamsOpt, INamedTypeRef baseClassOpt,
//             IEnumerable<INamedTypeRef> implements, IEnumerable<LangElement> members, Span bodySpan)
//         {
//             var tref = (AnonymousTypeRef) base.AnonymousTypeReference(span, headingSpan, conditional, attributes,
//                 typeParamsOpt, baseClassOpt, implements, members, bodySpan);
//
...
//         }
//
//         public override LangElement Lambda(Span span, Span headingSpan, bool aliasReturn, TypeRef returnType,
//             IEnumerable<FormalParam> formalParams, Span formalParamsSpan, IEnumerable<FormalParam> lexicalVars,
//             LangElement body)
//         {
//             return AddAndReturn(ref _lambdas,
//                 (LambdaFunctionExpr) base.Lambda(span, headingSpan, aliasReturn, returnType, formalParams,
//                     formalParamsSpan, lexicalVars, body));
//         }
//
//         public override LangElement ArrowFunc(Span span, Span headingSpan, bool aliasReturn, TypeRef returnType,
//             IEnumerable<FormalParam> formalParams, Span formalParamsSpan, LangElement expression)
//         {
//             return AddAndReturn(ref _lambdas,
//                 (ArrowFunctionExpr) base.ArrowFunc(span, headingSpan, aliasReturn, returnType, formalParams,
...
//         {
//             return
//                 base.Literal(span, value,
//                     originalValue: null); // discard the original value string, not needed, free some memory
//         }
//
...
//             expression;
//
//         public override LangElement HeredocExpression(Span span, LangElement expression, Tokens quoteStyle,
...
//         }
//
//         public override LangElement Call(Span span, TranslatedQualifiedName name, CallSignature signature,
//             LangElement memberOfOpt)
//         {

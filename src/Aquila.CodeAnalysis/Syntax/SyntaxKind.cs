...
#pragma warning disable CA1200 // Avoid using cref tags with a prefix - The prefix is required since this file is referenced in projects that can't access syntax nodes
    ...
    public enum SyntaxKind : ushort
    {
        ...
        /// <summary>Represents <see langword="pub"/>.</summary>
        PubKeyword = 8343,
        ...
        /// <remarks>For example <c>Dictionary&lt;,&gt;</c> which has <see cref="OmittedTypeArgumentToken"/> as a child of <see cref="T:Aquila.CodeAnalysis.Syntax.OmittedTypeArgumentSyntax"/> before and after the <see cref="CommaToken"/>.</remarks>
        OmittedTypeArgumentToken = 8492,

        /// <summary>Represents that nothing was specified as an array size.</summary>
        /// <remarks>For example <c>int[,]</c> which has <see cref="OmittedArraySizeExpressionToken"/> as a child of <see cref="T:Aquila.CodeAnalysis.Syntax.OmittedArraySizeExpressionSyntax"/> before and after the <see cref="CommaToken"/>.</remarks>

...
//
//         public AdditionalSyntaxProvider(PhpTokenProvider provider, NodesFactory nodes,
//             Func<QualifiedNameRef, bool, TypeRef> typeRefFactory)
//         {
...
//         {
//             get => _provider.DocBlock;
//             set => _provider.DocBlock = value;
//         }
//
...
//             ((ITokenProvider<TValue, TSpan>) _provider).ReportError(expectedTokens);
//
//         public void Dispose()
//         {
...
//                             (next.Token == Tokens.T_DOUBLE_COLON || next.Token == Tokens.T_LPAREN))
//                         {
//                             // we got it!
...
//
//                 _provider.UpdateToken(new CompleteToken(Tokens.T_STRING, new TValue {String = text},
//                     _provider.TokenPosition, text));
//                 return true;
//             }
//
//             //

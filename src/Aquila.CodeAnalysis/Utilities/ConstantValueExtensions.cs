...
namespace Aquila.CodeAnalysis
{
    internal static class ConstantValueExtensions
    {
        ...
        /// <summary>
        /// Aquila safe implicit conversion to <c>long</c> (null|long|double to long).
        /// </summary>
        ...
        /// <summary>
        /// Safe implicit conversion to <c>bool</c> if the value is known.
        /// </summary>
        ...
        /// <summary>
        /// Aquila safe implicit conversion to <c>long</c> if the value is known.
        /// </summary>
        ...
        /// </summary>
        public static Optional<object> AsOptional(this long l) =>
            new Optional<object>(l == 0L ? s_long_zero : (object)l);

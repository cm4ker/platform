...
namespace Aquila.CodeAnalysis.Semantics
{
        ...
        internal override TypeSymbol Emit(CodeGenerator cg)
        {
            ...
            switch (Operation)
            {
                ...
                case Operations.BitAnd:
                    cg.EmitOpCode(ILOpCode.And);
                    break;
                case Operations.BitOr:
                    cg.EmitOpCode(ILOpCode.Or);
                    break;
                case Operations.BitXor:
                    cg.EmitOpCode(ILOpCode.Xor);
                    break;
                case Operations.And:
                    cg.EmitOpCode(ILOpCode.And);
                    returnedType = cg.DeclaringCompilation.CoreTypes.Boolean;
                ...
                default: throw new Exception($"Op not supported {Operation}");
            }
    ...
    partial class BoundIncDecEx
    {
        internal override TypeSymbol Emit(CodeGenerator cg)
        {
            ...
            TypeSymbol result_type = (TypeSymbol)this.Target.ResultType;

...
namespace Aquila.CodeAnalysis.Semantics.Graph
{
    ...
    internal abstract class GraphVisitor<TResult> : BoundTreeVisitor
    {
        /// <summary>Visits given block.</summary>
        protected BoundNode Accept(BoundBlock x) => (x != null) ? x.Accept(this) : default;

        /// <summary>Visits given edge.</summary>
        protected BoundNode Accept(Edge x) => (x != null) ? x.Accept(this) : default;

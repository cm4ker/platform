...
namespace Aquila.CodeAnalysis.Semantics
{
    ...
    internal class Binder1
    {
        ...
        BoundStatement BindStatementCore(Statement stmt)
        {
            ...
            throw new Exception($"{stmt.GetType().Name} not supported");
        ...
        //         },
        //         new SynthesizedStaticLocHolder(this.Method, decl.Variable.Value));
        // }
        //
        ...
        // {
        //     Method.Flags |= MethodFlags.HasEval;
        //
        ...
        // {
        //     Method.Flags |= MethodFlags.HasInclude;
        //
        ...
        //         Method.Flags |= MethodFlags.HasUserFunctionCall;
        //     }
        //
        //     //
        //     if (boundTarget == null)
        ...
        //         if (boundTarget == null)
        //         {
        //             if (fname.IsGetArgsOrArgsNumFunctionName() && Method != null)
        //             {
        //                 // remember we need varargs:
        //                 Method.Flags |= MethodFlags.UsesArgs;
        //
        //                 // cannot use in global scope
        //                 if (Method.IsGlobalScope)
        //                 {
        ...
        //             ? new BoundMethodName(new QualifiedName(dm.MethodName))
        //             : new BoundMethodName(new BoundConversionEx(
        ...
        public IBoundTypeRef BindTypeRef(Aquila.Syntax.Ast.TypeRef tref, bool objectTypeInfoSemantic = false)
        {
            ...
            // //     Method != null)
            // // {
            // //     Method.Flags |= MethodFlags.UsesLateStatic;
            // // }
            //
            // //
            // return type;

...
namespace Aquila.CodeAnalysis.Semantics
{
    ...
    internal class Binder1
    {
        ...
        /// <summary>
        /// Creates <see cref="Binder1"/> for given routine (passed with <paramref name="locals"/>).
        /// </summary>
            ...
            object self = null)
        {
            ...
            return (isGeneratorMethod)
                ? new GeneratorBinder(compilation, ImmutableArray<IYieldLikeEx>.Empty, locals, routine, self)
                : new Binder1(compilation, file, locals, routine, self);
        }
    ...
    internal sealed class GeneratorBinder : Binder1
    {
        ...
        public GeneratorBinder(AquilaCompilation compilation, ImmutableArray<IYieldLikeEx> yields,

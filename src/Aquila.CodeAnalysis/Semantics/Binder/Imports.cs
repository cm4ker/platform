...
namespace Aquila.CodeAnalysis
{
    ...
    internal sealed class Imports
    {
        internal static readonly Imports Empty = new Imports(
            ImmutableDictionary<string, ImportDecl>.Empty,
            ImmutableArray<ImportDecl>.Empty);

        public readonly ImmutableDictionary<string, ImportDecl> UsingAliases;
        public readonly ImmutableArray<ImportDecl> Usings;

        private Imports(
            ImmutableDictionary<string, ImportDecl> usingAliases,
            ImmutableArray<ImportDecl> usings)
        {
        ...
        // internal static Imports ExpandPreviousSubmissionImports(Imports previousSubmissionImports, AquilaCompilation newSubmission)
        // {
        ...
        // internal static ImmutableArray<NamespaceOrTypeAndUsingDirective> ExpandPreviousSubmissionImports(ImmutableArray<NamespaceOrTypeAndUsingDirective> previousSubmissionUsings, AquilaCompilation newSubmission)
        // {
        //     Debug.Assert(newSubmission.IsSubmission);
        //
        ...
        public static Imports Create(
            ImmutableDictionary<string, ImportDecl> usingAliases, ImmutableArray<ImportDecl> usings)
        {
            Debug.Assert(usingAliases != null);
            Debug.Assert(!usings.IsDefault);
        ...
        internal Imports Concat(Imports otherImports)
        {
            ...
            //
            // var usingAliases =
            //     this.UsingAliases.SetItems(otherImports.UsingAliases); // NB: SetItems, rather than AddRange
        ...
        //     return externs1.WhereAsArray((e, replacedExternAliases) => !replacedExternAliases.Contains(e.Alias.Name),
        ...
        //     }
        //
        //     bool IEqualityComparer<NamespaceOrTypeAndUsingDirective>.Equals(NamespaceOrTypeAndUsingDirective x,

...
namespace Aquila.CodeAnalysis.Semantics
{
    ...
    abstract class Binder
    {
        ...
        protected BoundStatement BindReturnStmt(ReturnStmt stmt)
        {
            ...
            return new BoundReturnStatement(stmt, RefKind.None, expr);
        }
        ...
        protected Location GetLocation(AquilaSyntaxNode expr) => expr.GetLocation();
        ...
        protected virtual BoundExpression BindName(SimpleNameEx expr, ArgumentListSyntax argumentList, bool invocation)
        {
            ...
            //     .Select(x =>  BoundArgument() BoundArgument.Create(BindExpression(x.Expression)))
            //     .ToImmutableArray();
            //

...
namespace Aquila.CodeAnalysis.Semantics
{
    public class AquilaSemanticModel : SemanticModel
    {
        ...
        public AquilaSemanticModel(AquilaCompilation compilation, SyntaxTree syntaxTree)
        {
        ...
        public override string Language => "aqlang";
        protected override Compilation CompilationCore => _compilation;
        protected override SyntaxTree SyntaxTreeCore => _syntaxTree;

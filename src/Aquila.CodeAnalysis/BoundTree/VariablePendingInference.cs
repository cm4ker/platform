...
namespace Aquila.CodeAnalysis
{
    ...
    internal partial class VariablePendingInference : BoundExpression
    {
        ...
        internal BoundExpression SetInferredTypeWithAnnotations(TypeWithAnnotations type, Binder? binderOpt,
            BindingDiagnosticBag? diagnosticsOpt)
        {
...
//                                 : this.Syntax;
//
//                             Binder.CheckRestrictedTypeInAsyncMethod(localSymbol.ContainingSymbol, type.Type,
//                                 diagnosticsOpt, typeOrDesignationSyntax);
//                         }
//                     }
//
//                     localSymbol.SetTypeWithAnnotations(type);
//                     return new BoundLocal(this.Syntax, localSymbol, BoundLocalDeclarationKind.WithInferredType,
//                         constantValueOpt: null, isNullableUnknown: false, type: type.Type,
//                         hasErrors: this.HasErrors || inferenceFailed).WithWasConverted();
//

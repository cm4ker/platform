...
partial class MetadataSymbolProvider
{
    ...
    private void PopulateTableCollection(SMEntity md, SMTable table)
    {
        ...
        var listDtoType = _ct.AqList.Construct(rowObjectType);
        ...
        var innerListField = _ps.SynthesizeField(_ct.AqList.Construct(rowObjectType))
            .SetName("_innerList")
            .SetAccess(Accessibility.Private)
            .SetType(dtoType);
        ...
        var create = _ps.SynthesizeMethod(collectionType)
            ...
            .SetMethodBuilder(((m, d) => (il) =>
            {
                ...
                il.EmitCall(m, d, ILOpCode.Newobj, rowDtoType.Ctor(_ct.AqContext, rowDtoType));

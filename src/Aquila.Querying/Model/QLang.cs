...
namespace Aquila.Core.Querying.Model
{
    public class QLang
    {
        ...
        public static QLangElement Parse(QLang machine, string sql)
        {
            ...
            QLangGrammarLexer speakLexer = new QLangGrammarLexer(inputStream);
            CommonTokenStream commonTokenStream = new CommonTokenStream(speakLexer);
            QLangGrammarParser parser = new QLangGrammarParser(commonTokenStream);
            QLangGrammarVisitor visitor = new QLangGrammarVisitor(machine);
        ...
        /// <summary>
        /// applies count function top of the stack
        /// </summary>
        /// <returns></returns>
        public QLang count()
        {
            _logicStack.Push(new QCount());
            return this;
        }

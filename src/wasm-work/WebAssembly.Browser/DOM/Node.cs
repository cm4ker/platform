...
namespace WebAssembly.Browser.DOM
{
    ...
    public class Node : EventTarget, IEventTarget
    {
        ...
        //public Node() { }
        [Export("ATTRIBUTE_NODE")] public double AttributeNode => GetProperty<double>("ATTRIBUTE_NODE");
        [Export("CDATA_SECTION_NODE")] public double CdataSectionNode => GetProperty<double>("CDATA_SECTION_NODE");
        [Export("COMMENT_NODE")] public double CommentNode => GetProperty<double>("COMMENT_NODE");

        [Export("DOCUMENT_FRAGMENT_NODE")]
        public double DocumentFragmentNode => GetProperty<double>("DOCUMENT_FRAGMENT_NODE");

        [Export("DOCUMENT_NODE")] public double DocumentNode => GetProperty<double>("DOCUMENT_NODE");
        ...
        public double DocumentPositionImplementationSpecific =>
            GetProperty<double>("DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC");

        [Export("DOCUMENT_POSITION_PRECEDING")]
        public double DocumentPositionPreceding => GetProperty<double>("DOCUMENT_POSITION_PRECEDING");

        [Export("DOCUMENT_TYPE_NODE")] public double DocumentTypeNode => GetProperty<double>("DOCUMENT_TYPE_NODE");
        [Export("ELEMENT_NODE")] public double ElementNode => GetProperty<double>("ELEMENT_NODE");
        [Export("ENTITY_NODE")] public double EntityNode => GetProperty<double>("ENTITY_NODE");

        [Export("ENTITY_REFERENCE_NODE")]
        public double EntityReferenceNode => GetProperty<double>("ENTITY_REFERENCE_NODE");

        [Export("NOTATION_NODE")] public double NotationNode => GetProperty<double>("NOTATION_NODE");

        [Export("PROCESSING_INSTRUCTION_NODE")]
        public double ProcessingInstructionNode => GetProperty<double>("PROCESSING_INSTRUCTION_NODE");

        [Export("TEXT_NODE")] public double TextNode => GetProperty<double>("TEXT_NODE");
        [Export("attributes")] public NamedNodeMap Attributes => GetProperty<NamedNodeMap>("attributes");
        [Export("baseURI")] public string BaseUri => GetProperty<string>("baseURI");
        [Export("childNodes")] public NodeList ChildNodes => GetProperty<NodeList>("childNodes");
        [Export("firstChild")] public Node FirstChild => GetProperty<Node>("firstChild");
        [Export("lastChild")] public Node LastChild => GetProperty<Node>("lastChild");
        [Export("localName")] public string LocalName => GetProperty<string>("localName");
        [Export("namespaceURI")] public string NamespaceUri => GetProperty<string>("namespaceURI");
        [Export("nextSibling")] public Node NextSibling => GetProperty<Node>("nextSibling");
        [Export("nodeName")] public string NodeName => GetProperty<string>("nodeName");
        [Export("nodeType")] public double NodeType => GetProperty<double>("nodeType");

        [Export("nodeValue")]
        public string NodeValue
        {
            get => GetProperty<string>("nodeValue");
            set => SetProperty<string>("nodeValue", value);
        }

        [Export("ownerDocument")] public Document OwnerDocument => GetProperty<Document>("ownerDocument");
        [Export("parentElement")] public HTMLElement ParentElement => GetProperty<HTMLElement>("parentElement");
        [Export("parentNode")] public Node ParentNode => GetProperty<Node>("parentNode");
        [Export("previousSibling")] public Node PreviousSibling => GetProperty<Node>("previousSibling");

        [Export("textContent")]
        public string TextContent
        {
            get => GetProperty<string>("textContent");
            set => SetProperty<string>("textContent", value);
        }

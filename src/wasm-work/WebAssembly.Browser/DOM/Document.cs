...
namespace WebAssembly.Browser.DOM
{
    ...
    public sealed partial class Document : Node
    {
        ...
        [Export("activeElement")] public Element ActiveElement => GetProperty<Element>("activeElement");

        [Export("alinkColor")]
        public string AlinkColor
        {
            get => GetProperty<string>("alinkColor");
            set => SetProperty<string>("alinkColor", value);
        }
        ...
        {
            get => GetProperty<HTMLCollectionOf<HTMLAnchorElement>>("anchors");
            set => SetProperty<HTMLCollectionOf<HTMLAnchorElement>>("anchors", value);
        }
        ...
        public HTMLElement Body
        {
            ...
            set => SetProperty<HTMLElement>("body", value);
        }

        [Export("characterSet")] public string CharacterSet => GetProperty<string>("characterSet");

        [Export("charset")]
        public string Charset
        {
            get => GetProperty<string>("charset");
            set => SetProperty<string>("charset", value);
        }

        [Export("compatMode")] public string CompatMode => GetProperty<string>("compatMode");

        [Export("cookie")]
        public string Cookie
        {
            get => GetProperty<string>("cookie");
            set => SetProperty<string>("cookie", value);
        }

        [Export("currentScript")] public object CurrentScript => GetProperty<object>("currentScript");
        [Export("defaultView")] public Window DefaultView => GetProperty<Window>("defaultView");

        [Export("designMode")]
        public string DesignMode
        {
            get => GetProperty<string>("designMode");
            set => SetProperty<string>("designMode", value);
        }
        ...
        public string Dir
        {
            ...
            set => SetProperty<string>("dir", value);
        }

        [Export("doctype")] public DocumentType Doctype => GetProperty<DocumentType>("doctype");

        [Export("documentElement")]
        public HTMLElement DocumentElement
        {
            get => GetProperty<HTMLElement>("documentElement");
            set => SetProperty<HTMLElement>("documentElement", value);
        }
        ...
        public string FgColor
        {
            ...
            set => SetProperty<string>("fgColor", value);
        }

        [Export("forms")]
        public HTMLCollectionOf<HTMLFormElement> Forms
        {
            get => GetProperty<HTMLCollectionOf<HTMLFormElement>>("forms");
            set => SetProperty<HTMLCollectionOf<HTMLFormElement>>("forms", value);
        }

        [Export("fullscreenElement")] public Element FullscreenElement => GetProperty<Element>("fullscreenElement");
        [Export("fullscreenEnabled")] public bool FullscreenEnabled => GetProperty<bool>("fullscreenEnabled");
        [Export("head")] public HTMLHeadElement Head => GetProperty<HTMLHeadElement>("head");

        [Export("hidden")] public bool Hidden => GetProperty<bool>("hidden");
        ...
        [Export("inputEncoding")] public string InputEncoding => GetProperty<string>("inputEncoding");
        [Export("lastModified")] public string LastModified => GetProperty<string>("lastModified");

        [Export("linkColor")]
        public string LinkColor
        {
            get => GetProperty<string>("linkColor");
            set => SetProperty<string>("linkColor", value);
        }
        ...
        [Export("location")] public Location Location => GetProperty<Location>("location");

        [Export("msCapsLockWarningOff")]
        public bool MsCapsLockWarningOff
        {
            get => GetProperty<bool>("msCapsLockWarningOff");
            set => SetProperty<bool>("msCapsLockWarningOff", value);
        }

        [Export("msCSSOMElementFloatMetrics")]
        public bool MsCssomElementFloatMetrics
        {
            get => GetProperty<bool>("msCSSOMElementFloatMetrics");
            set => SetProperty<bool>("msCSSOMElementFloatMetrics", value);
        }
        ...
        [Export("pointerLockElement")] public Element PointerLockElement => GetProperty<Element>("pointerLockElement");
        [Export("readyState")] public string ReadyState => GetProperty<string>("readyState");

        [Export("referrer")] public string Referrer => GetProperty<string>("referrer");
        ...
        [Export("scrollingElement")] public Element ScrollingElement => GetProperty<Element>("scrollingElement");
        ...
        [Export("URL")] public string Url => GetProperty<string>("URL");
        [Export("URLUnencoded")] public string UrlUnencoded => GetProperty<string>("URLUnencoded");
        ...
        public string VlinkColor
        {
            ...
            set => SetProperty<string>("vlinkColor", value);
        }
        ...
        [Export("webkitIsFullScreen")] public bool WebkitIsFullScreen => GetProperty<bool>("webkitIsFullScreen");
        [Export("xmlEncoding")] public string XmlEncoding => GetProperty<string>("xmlEncoding");

        [Export("xmlStandalone")]
        public bool XmlStandalone
        {
            get => GetProperty<bool>("xmlStandalone");
            set => SetProperty<bool>("xmlStandalone", value);
        }

        [Export("xmlVersion")]
        public string XmlVersion
        {
            get => GetProperty<string>("xmlVersion");
            set => SetProperty<string>("xmlVersion", value);
        }

        //[Export("ownerDocument")]
        //public Document OwnerDocument => GetProperty<Document>("ownerDocument");
        [Export("parentElement")] public new HTMLElement ParentElement => GetProperty<HTMLElement>("parentElement");
        [Export("parentNode")] public Node IParentNode => GetProperty<Node>("parentNode");
        ...
        [Export("children")] public HTMLCollection Children => GetProperty<HTMLCollection>("children");
        [Export("firstElementChild")] public Element FirstElementChild => GetProperty<Element>("firstElementChild");
        [Export("lastElementChild")] public Element LastElementChild => GetProperty<Element>("lastElementChild");

        [Export("childElementCount")] public double ChildElementCount => GetProperty<double>("childElementCount");
        ...
        {
            var result = InvokeMethod<HTMLElement>("getElementById", elementId);

    ...
    public sealed partial class PhpCompilation : Compilation
    {
        ...
        protected override IMethodSymbol CommonGetEntryPoint(CancellationToken cancellationToken)
        {
            if (_lazyMainMethod == null && this.Options.OutputKind.IsApplication())
            {
                ...
                if (method == null)
                {
                    DeclarationDiagnostics.Add(Location.None, Errors.ErrorCode.ERR_StartupObjectNotFound,
        ...
        internal override AnalyzerDriver AnalyzerForLanguage(ImmutableArray<DiagnosticAnalyzer> analyzers,
        ...
        internal override bool CompileMethods(CommonPEModuleBuilder moduleBuilder, bool emittingPdb,
            bool emitMetadataOnly, bool emitTestCoverageData, DiagnosticBag diagnostics, Predicate<ISymbol> filterOpt,
            CancellationToken cancellationToken)
        {

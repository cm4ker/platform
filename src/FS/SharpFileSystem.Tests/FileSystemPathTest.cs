...
namespace SharpFileSystem.Tests
{
    ...
    public class FileSystemPathTest
    {
        ...
        public void ParentPathTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => Assert.Equal(root.ParentPath, root.ParentPath));
        }
        ...
        public void RemoveParentTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => fileB.RemoveParent(FileSystemPath.Parse("/nonexistantparent/")));
            Assert.Throws<ArgumentException>(() => fileB.RemoveParent(FileSystemPath.Parse("/nonexistantparent")));
            Assert.Throws<ArgumentException>(() => fileB.RemoveParent(FileSystemPath.Parse("/fileb.txt")));
            Assert.Throws<ArgumentException>(() => fileB.RemoveParent(FileSystemPath.Parse("/directorya")));
        }
        ...
        public void RemoveChildTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => directoryA.RemoveChild(FileSystemPath.Parse("/nonexistantchild")));
            Assert.Throws<ArgumentException>(() => directoryA.RemoveChild(FileSystemPath.Parse("/directorya")));
        }
        ...
        public void ParseTest()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => FileSystemPath.Parse(null));
            Assert.Throws<ParseException>(() => FileSystemPath.Parse("thisisnotapath"));
            Assert.Throws<ParseException>(() => FileSystemPath.Parse("/thisisainvalid//path"));
        }
        ...
        public void GetExtensionTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => directoryA.GetExtension());
        }
        ...
        public void ChangeExtensionTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => directoryA.ChangeExtension(".exe"));
        }
        ...
        public void AppendPathTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => fileA.AppendPath(subpath));
            Assert.Throws<InvalidOperationException>(() => fileA.AppendPath(subpathstr));
            Assert.Throws<ArgumentException>(() => directoryA.AppendPath("/rootedpath/"));
        }
        ...
        public void AppendFileTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => fileA.AppendFile("file"));
            Assert.Throws<ArgumentException>(() => directoryA.AppendFile("dir/file"));
        }
        ...
        public void AppendDirectoryTest()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => fileA.AppendDirectory("dir"));
            Assert.Throws<ArgumentException>(() => root.AppendDirectory("dir/dir"));
        }
    }
}